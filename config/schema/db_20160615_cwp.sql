...
-- 正在导出表  binggq.flow 的数据：~2 rows (大约)
DELETE FROM `flow`;
/*!40000 ALTER TABLE `flow` DISABLE KEYS */;
INSERT INTO `flow` (`id`, `user_id`, `type`, `type_msg`, `income`, `amount`, `pre_amount`, `after_amount`, `status`, `remark`, `create_time`, `update_time`) VALUES
	(1, 7, 1, '约见收入', 1, 150.00, 0.00, 150.00, 1, '约见获取收入:150', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(2, 8, 1, '约见收入', 1, 150.00, 0.00, 150.00, 1, '约见获取收入:150', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `order` (`id`, `type`, `relate_id`, `user_id`, `seller_id`, `order_no`, `out_trade_no`, `paytype`, `price`, `fee`, `remark`, `status`, `create_time`, `update_time`) VALUES
	...
	(6, 1, 6, 8, 7, '14648392418692', NULL, 1, 150.00, 0.00, '预约话题测试话题', 1, '2016-06-02 11:47:21', '2016-06-13 19:59:57');
...
INSERT INTO `subject_book` (`id`, `subject_id`, `user_id`, `savant_id`, `summary`, `status`, `create_time`, `update_time`) VALUES
	(6, 4, 8, 7, 'gasgdsa1', 3, '2016-05-26 18:27:45', '2016-06-13 19:59:57'),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `phone` varchar(20) NOT NULL COMMENT '手机号',
  `user_token` varchar(20) NOT NULL COMMENT '用户识别token',
...
INSERT INTO `user` (`id`, `phone`, `user_token`, `wx_openid`, `truename`, `level`, `idcard`, `company`, `position`, `email`, `gender`, `agency_id`, `ext_industry`, `goodat`, `city`, `card_path`, `avatar`, `money`, `meet_nums`, `fans`, `ymjy`, `ywnl`, `reason`, `status`, `savant_status`, `enabled`, `create_time`, `update_time`) VALUES
	(7, '18681509040', '', '', '郑旭', '2', '', '中青文化投资管理有限公司', '互联网事业部副总经理', 'claus@smartlemon.cn', 1, 17, '6642', '', '', '/upload/user/mp/2016-05-05/572b2466c4068.jpg', '/upload/user/avatar/avatar2.jpg', 150.00, 0, 1, '', '', '', 2, 1, 1, '2016-05-05 18:46:01', '2016-06-13 19:59:57'),
	(8, '18316629973', '5760b3d3207fc', 'oZVmqjjrFxADkBG1YDYSqk36G3oo', '曹麦穗', '2', '', '广东深宏盾律师事务所', '共产主义接班人', '714265403@qq.com', 1, 13, '打dota', '', '', '/upload/user/mp/2016-05-09/57305f00c5c1a.jpg', 'http://wx.qlogo.cn/mmopen/ajNVdqHZLLCOibYvNGzNtJmgyOEpAyhkd45A3gbGgt2mbDYUdMeBVbbe9SmxwJiceNGd4ibZCeKTHSDq1kJDkVibXQ/0', 150.00, 0, 1, '', '', '', 2, 3, 1, '2016-05-09 17:57:24', '2016-05-13 17:43:16'),
...
INSERT INTO `usermsg` (`id`, `user_id`, `type`, `table_id`, `title`, `msg`, `num`, `url`, `status`, `create_time`, `update_time`) VALUES
	...
	(33, 8, 4, 6, '预约通知', '您预约的话题：\'测试话题\'已确认通过，请及时登录平台支付预约款。', 0, '/home/my-book-savant', 1, '2016-06-02 11:09:52', '2016-06-02 11:09:52'),
	(34, 8, 4, 6, '预约通知', '您预约的话题：\'测试话题\'已确认通过，请及时登录平台支付预约款。', 0, '/home/my-book-savant', 1, '2016-06-02 11:21:25', '2016-06-02 11:21:25'),
	(35, 8, 4, 6, '预约通知', '您预约的话题：《测试话题》已确认通过，请及时登录平台支付预约款。', 0, '/home/my-book-savant', 1, '2016-06-02 11:47:22', '2016-06-02 11:47:22');
...
INSERT INTO `withdraw` (`id`, `user_id`, `amount`, `cardno`, `bank`, `truename`, `fee`, `remark`, `status`, `create_time`, `update_time`) VALUES
	(6, 8, 110, '134444045', '平安银行', '曹麦穗', 0, '0', 0, '2016-06-14 17:31:57', '2016-06-14 17:31:57');
