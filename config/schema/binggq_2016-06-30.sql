...
--
-- Host: localhost
-- Generation Time: 2016-06-30 15:43:37
-- 服务器版本： 5.5.37-log
-- PHP Version: 5.6.21
...
) ENGINE=InnoDB AUTO_INCREMENT=83 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志表';
...
(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-06-30 11:16:03', '2016-06-30 11:16:03', '163.125.75.24');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='赠名片表';
...
CREATE TABLE IF NOT EXISTS `collect` (
  ...
  `update_time` datetime NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='点赞日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='评论点赞表';
...
CREATE TABLE IF NOT EXISTS `like_logs` (
  ...
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `type` tinyint(4) NOT NULL COMMENT '类型值：0：活动；1：资讯'
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='点赞日志表';
...
(29, 2, '曹麦穗', '退欧一声炮响 英国巨富轰然“出血”55亿美元', 168, 4, 17, '/upload/newscover/2016-06-25/576e6f541cc16.png', '<p>退欧派胜出的英国公投结果公布后，英镑暴跌11%，直逼1.32，创英国自1970年初实行浮动汇率以来的最大日内跌幅。不仅英国股市收跌近3%，欧洲股市整体也遭遇了史上最黑“黑色星期五”：在开盘暴跌后跌势有所缓和，但仍以6%以上的跌幅创2008年以来单日跌幅新高。</p><p><br/></p><p>上述报道还提到了巨富中的一位铁杆退欧派——英国金融业最大零售经纪商Hargreaves Lansdown的联合创始人Peter Hargreaves。周五盘中，他的资产市值锐减19%至29亿美元。Hargreaves个人为退欧拉票活动捐助了320万英镑（合440万美元），是为退欧捐款最多的英国富豪。他接受采访时称，支持留欧的政治家应该和市场大跌无关，因为英国就是要竭力从欧盟解脱出来。华尔街见闻此前文章提到，Starfort Investment Holdings的董事长Ken Courtis评论周五欧股大跌称，此前投资者都在押注留欧派胜出，如今这种结果导致人们蜂拥寻找掩护，“人们在向相反的方向调整，在同一时刻蜂拥试图从极小的门洞出逃。”</p>', '退欧派胜出的英国公投结果公布后，英镑暴跌11%，直逼1.32', '2016-06-25 19:47:34', '2016-06-30 15:37:41', 13, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='新闻评论表';
...
(49, 29, 0, 10, 0, 'oookkk', 1, '2016-06-25 20:34:01', '2016-06-29 19:54:58'),
...
(61, 29, 0, 17, 0, '一个大西瓜', 1, '2016-06-29 17:46:07', '2016-06-29 19:54:50'),
(62, 29, 46, 19, 10, '帅哥', 1, '2016-06-29 17:57:48', '2016-06-29 19:54:45'),
(63, 29, 0, 10, 0, '可以回复', 2, '2016-06-29 19:57:08', '2016-06-30 11:33:59'),
(64, 19, 0, 10, 0, 'GG哈哈哈哈', 2, '2016-06-30 11:31:54', '2016-06-30 13:22:48'),
(65, 19, 64, 19, 10, '我去', 1, '2016-06-30 13:23:15', '2016-06-30 15:21:08');
...
(19, '18316629973', 'cc0c50ea70b8b4ba5e78', 'oglBHw-G5fbNmQeUoZiyWl_M1Dgc', 'oqQRxsx_srEukkVOBQMVWsmPDPbY', 'oplMIwnDMBxytRnkyYXcTE2J6JSE', '曹麦穗', '1', '', '加利福尼亚', '共产主义接班人', 'caowenpeng1990@126.com', 1, 22, '打dota', '', '', '/upload/user/mp/2016-06-29/5773997609f3c.jpg', '/upload/user/avatar/2016-06-30/thumb_57748e58ee39b.jpg', '0.00', 0, 0, '', '', '', 1, 1, 1, '2016-06-29 17:56:33', '2016-06-30 13:18:16');
...
CREATE TABLE IF NOT EXISTS `usermsg` (
  ...
  `create_time` datetime NOT NULL,
  `update_time` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='用户消息';
...
--
ALTER TABLE `actionlog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',AUTO_INCREMENT=83;
--
...
--
ALTER TABLE `card_box`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '赠名片表',AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `collect`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '点赞日志表',AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `comment_like`
--
ALTER TABLE `comment_like`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '评论点赞表',AUTO_INCREMENT=46;
--
...
--
ALTER TABLE `like_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '点赞日志表',AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `newscom`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '新闻评论表',AUTO_INCREMENT=66;
--
