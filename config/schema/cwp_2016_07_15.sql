...
CREATE TABLE IF NOT EXISTS `actionlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志表';

-- 正在导出表  binggq.actionlog 的数据：~130 rows (大约)
...
CREATE TABLE IF NOT EXISTS `activity_industry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='活动标签对映表';

-- 正在导出表  binggq.activity_industry 的数据：~28 rows (大约)
...
-- 正在导出表  binggq.activity_savant 的数据：~8 rows (大约)
...
INSERT INTO `admin` (`id`, `username`, `truename`, `password`, `phone`, `enabled`, `ctime`, `utime`, `login_time`, `login_ip`) VALUES
	(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-07-15 17:03:27', '2016-07-15 17:03:27', '127.0.0.1'),
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='重要的信息日志记录';

-- 正在导出表  binggq.log 的数据：~0 rows (大约)
DELETE FROM `log`;
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';
...
INSERT INTO `need` (`id`, `pid`, `reply_id`, `user_id`, `msg`, `status`, `create_time`, `update_time`) VALUES
	...
	(14, 0, 0, 25, '', 0, '2016-07-11 11:31:14', '2016-07-11 11:31:14'),
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='咨询表';
...
CREATE TABLE IF NOT EXISTS `news_industry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='新闻行业标签';
...
CREATE TABLE IF NOT EXISTS `news_savant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='专家推荐活动关系表';
...
CREATE TABLE IF NOT EXISTS `projrong` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='融资项目';

-- 正在导出表  binggq.projrong 的数据：~2 rows (大约)
...
INSERT INTO `projrong` (`id`, `user_id`, `publisher`, `company`, `title`, `stage_id`, `address`, `scale_id`, `stock`, `read_nums`, `praise_nums`, `comment_nums`, `cover`, `body`, `summary`, `comp_desc`, `team`, `attach`, `status`, `follow_id`, `follower`, `stage_remark`, `create_time`, `update_time`) VALUES
	...
	(4, 2, '并购帮', '腾讯科技', '母婴健康交流', '1', '深圳市南山区腾讯大厦', '1', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-07-15/5788e0a68be5b.jpg', '12312', '12', '33', '养生项目组', '/upload/proj/attach/2016-07-15/5788e0b8e32e2.jpg', 0, 0, '范冰冰', '呵呵', '2016-07-15 21:41:00', '2016-07-15 21:41:00'),
...
CREATE TABLE IF NOT EXISTS `rong_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='融资项目行业标签';
...
CREATE TABLE IF NOT EXISTS `secret` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='隐私设置';
...
CREATE TABLE IF NOT EXISTS `smsmsg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=240 DEFAULT CHARSET=utf8 COMMENT='短信记录';
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `register_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '注册步数',
...
-- 正在导出表  binggq.user 的数据：~23 rows (大约)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `phone`, `user_token`, `union_id`, `wx_openid`, `app_wx_openid`, `truename`, `level`, `grade`, `idcard`, `company`, `position`, `email`, `gender`, `agency_id`, `ext_industry`, `goodat`, `city`, `card_path`, `avatar`, `money`, `meet_nums`, `fans`, `ymjy`, `ywnl`, `gsyw`, `reason`, `grbq`, `admin_id`, `status`, `savant_status`, `register_status`, `enabled`, `create_time`, `update_time`) VALUES
	(2, '', '', NULL, '', '', '并购帮', 3, 1, '', '', '', '', 1, 0, '', '', '', '/upload/user/mp/2016-07-11/578306d7c828a.jpg', '/upload/user/avatar/2016-07-07/thumb_577e35a2415aa.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '0000-00-00 00:00:00', '2016-07-11 10:39:19'),
	(7, '18681509040', '', 'oglBHw957rd4_qnAjBb5HoEMSvSA', 'oqQRxswxqn-LYh2834g3168751yA', 'oplMIwqjBXqnmWjo0-C9D3EoX4zM', '郑旭', 2, 1, '', '柠檬智慧互联网咨询', '产品', 'claus@smartlemon.cn', 1, 17, '6642', '互联网咨询、传统企业转型升级', '深圳', '/upload/user/mp/2016-07-08/577f18a4c0e78.png', '/upload/user/avatar/2016-07-08/thumb_577f18645ec6e.png', 2550.00, 7, 6, '', '', '传统企业加速器', '更符合规范', 'a:1:{i:0;s:6:"产品";}', 0, 2, 3, 1, 1, '2016-05-05 18:46:01', '2016-07-12 11:12:53'),
	(9, '13560627825', '', 'oglBHw5Lw3uyiz_G-iPQ8riJtiLw', 'oqQRxs7Z-wldoLSVShHaaiaRLDEM', '', '游依婷', 1, 1, '', '广东深宏盾律师事务所', '', '71426333x@qq.com', 1, 28, '', '', '', '/upload/user/mp/2016-05-11/573312fbdeaa3.jpg', '/upload/user/avatar/2016-07-08/thumb_577f6408be79d.jpg', 0.00, 0, 1, '', '', NULL, '', 'a:1:{i:0;s:1:"a";}', 0, 1, 1, 1, 1, '2016-05-11 19:10:58', '2016-07-08 16:27:52'),
	(10, '13510663507', '5760b3d3207fk', 'oglBHw7ngF8JT7nLU7uf89n2kTMc', 'oqQRxs7aaLVQQQq6Ps4ae1FZx13g', 'oplMIwmgVK6mc1dAsDgXmT5LExYc', '周啸风', 2, 1, '', '柠檬智慧', '研发', 'xifeo@smartlemon.cn', 1, 5, '', '123asdfj j2222', '深圳', '/upload/user/mp/2016-06-07/5756bee45c3ac.jpg', '/upload/user/avatar/2016-07-08/thumb_577e826868f7f.png', 600.00, 2, 5, '', '', '咨询', '111', 'a:2:{i:0;s:6:"研发";i:1;s:6:"产品";}', 0, 1, 0, 1, 1, '2016-06-07 20:32:48', '2016-07-12 16:22:27'),
	(11, '15013797469', '', 'oglBHwydRTphIKEnYBRS1zfYvqkM', '', 'oplMIwlQbmVLv7QBsfLl8Dmm5EzE', 'key', 1, 1, '', '柠檬智慧咨询有限公司', 'web前端', '380552386@qq.com', 2, 11, '杂七杂八', '', '', '/upload/user/mp/2016-06-24/576ce8ff6448f.jpg', '/upload/user/avatar/2016-07-08/thumb_577f463787d70.jpg', 0.00, 0, 2, '', '', NULL, '奋斗奋斗', NULL, 0, 1, 0, 1, 1, '2016-06-24 16:04:00', '2016-07-08 15:38:15'),
	(12, '13510669757', '', NULL, '', '', '123', 1, 1, '', '123123', '123123', '123123@22.cn', 1, 0, '', '', '', '/upload/user/mp/2016-06-24/576d35e3805c7.jpg', '', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 2, 1, 0, '2016-06-24 21:30:14', '2016-07-07 19:28:22'),
	(13, '18576672803', '9d600de758dbdfcf32ad', 'oglBHw9b2Tnllf6Odqx7lxSN4YIQ', '', 'oplMIwtE0c9yt07HLCFfelxueWcc', '李芬', 1, 1, '', '并购菁英汇', '总裁', 'fannyli@chinama.club', 2, 20, '并购基金', '', '', '/upload/user/mp/2016-07-08/577f57f47a08a.png', '', 0.00, 0, 1, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-06-24 21:33:39', '2016-07-11 09:48:11'),
	(14, '18666822085', 'c65b3e2ca913bce64e86', NULL, '', '', '柳君', 1, 1, '', '并购菁英汇', '创始人', 'liujun@chinama.club', 2, 5, '结构化融资', '', '', '/upload/user/mp/2016-06-24/576d38f9f0e91.jpg', '/upload/user/avatar/2016-07-09/thumb_578083f798a7f.png', 0.00, 0, 2, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-06-24 21:44:07', '2016-07-12 00:18:06'),
	(15, '15914057632', '', 'oglBHw5JZx4fFFo85XM73g2ouL6M', '', 'oplMIwgh4reCtBkjnZuYYMorucbk', '杜胜佳', 1, 1, '', '柠檬智慧', 'iOS', '2394799027@qq.com', 1, 0, '', '', '', '/upload/user/mp/2016-07-12/57848aae127c7.png', '/upload/user/avatar/2016-07-12/thumb_5784a38353c2c.png', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-06-25 12:21:13', '2016-07-12 18:30:06'),
	(16, '18503039067', '0c64ded4de1144b70344', NULL, '', '', '高强', 1, 1, '', '柠檬智慧', 'PM', '37373838@qq.com', 1, 25, '', '', '', '/upload/user/mp/2016-06-25/576e83eec7e50.jpg', '', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 3, 1, 1, '2016-06-25 21:16:29', '2016-07-05 20:46:08'),
	(17, '13922806080', 'c7d35cc52e6fa749d63c', 'oglBHw3XLmsyQwxONqDYLheJ7Sis', 'oqQRxs60He2s7FCEU8OzXo45lg0M', '', '郑巽议', 2, 1, '', '柠檬', '产品', '1747371814@qq.com', 1, 5, '', '', '', '/upload/user/mp/2016-06-26/576f4b9b6d7e7.jpg', '', 1.00, 1, 1, 'AA受到法律思考的法律', '', NULL, '', NULL, 0, 2, 3, 1, 1, '2016-06-26 11:27:00', '2016-07-06 22:28:43'),
	(18, '13530229625', '04c4b10979bb30d6fe27', 'oglBHw4pSUtpwdN2GQkAIqdmb5Gs', 'oqQRxs7zWwx10JUNNFKs4iRMhVyw', 'oplMIwjL4adjAGV-59R_jUo7uAT4', '陈荣', 0, 1, '', '柠檬智慧', '设计师', '346159951@qq.com', 1, 5, '', '', '', '/upload/user/mp/2016-06-28/5771da1747f70.jpg', 'http://wx.qlogo.cn/mmopen/rElKOG5jB0J4mUeRNkicicYOQLl4y8IPHLtVYTnJ6Yqrk5MfwTsQQYiajyYavrEtZSAkxLjxicKOpSeG3Pvicqibx78Vj0bH5edvyR/0', 0.00, 0, 0, '', '', '测试测试 测试', '', 'a:2:{i:0;s:6:"研发";i:1;s:6:"设计";}', 0, 2, 1, 1, 1, '2016-06-28 10:00:15', '2016-07-07 18:12:39'),
	(20, '18681540783', '16926776095be98d0358', 'oglBHwxuSzg5OxxUVNVMY07M-0MQ', '', 'oplMIwl-UVA1js6Noy1y8rA7PpxY', '韦世魁', 0, 1, '', '柠檬智慧', '产品总监', 'welber@smartlelmon.cn', 1, 20, '', '', '', '/upload/user/mp/2016-07-04/577a5192a7099.jpg', '/upload/user/avatar/2016-07-04/thumb_577a52fbdecce.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-04 20:08:58', '2016-07-06 21:02:33'),
	(21, '18316629973', '51b98b86bbb3a5ddbf68', 'oglBHw-G5fbNmQeUoZiyWl_M1Dgc', 'oqQRxsx_srEukkVOBQMVWsmPDPbY', 'oplMIwnDMBxytRnkyYXcTE2J6JSE', '曹文鹏', 1, 1, '', '广州市时尚商业城有限公司', '总经理', 'caowenpeng1990@12.com', 1, 17, '', '', '', '/upload/user/mp/2016-07-08/577f2b055e9bb.jpg', '/upload/user/avatar/2016-07-08/thumb_577f44aed3af1.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 2, 1, 1, 1, '2016-07-05 22:10:42', '2016-07-12 20:38:18'),
	(22, '13650256334', '94a886347ebc45b448a6', 'oglBHww7VB8mFT7-EQ_WxvoFkgsM', '', 'oplMIwoPgcXKztmbadSrvy8E-Ubo', '雷婕', 1, 1, '', '柠檬智慧', '经理', 'xxx@qq.com', 1, 25, '', '', '', '/upload/user/mp/2016-07-08/577f29df288d9.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-08 12:24:06', '2016-07-08 12:24:39'),
	(23, '15811808140', '9c8cd8c29490f4174cd7', 'oglBHw0LIPNi64Ag35GNL848-JCc', '', 'oplMIwp4tAXG7opso1-TaLvqtlgs', '后雅弘', 1, 1, '', '并购菁英汇', '运营专员', 'houyahong@chinama.club', 2, 5, '', '', '', '/upload/user/mp/2016-07-09/57800e41a323a.jpg', '/upload/user/avatar/2016-07-11/thumb_5782fff6e2f81.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-09 04:34:30', '2016-07-11 10:09:59'),
	(24, '13303913119', '052d6911dd4fdeff004f', 'oglBHwxgwhvWzVgqhzs1cS6dqAZI', '', 'oplMIwruc7-zBKKd72l_2yu0BMbM', '朱晋辉', 1, 1, '', '并购菁英汇', '运营专员', 'zhujinhui@chinama.club', 1, 20, '', '', '', '/upload/user/mp/2016-07-09/5780f6bd27c9e.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-09 21:07:44', '2016-07-09 21:09:26'),
	(25, '13246730326', 'cba0467b7f731f3023be', 'oglBHw46WOcXapmDEpCp2GJriSlc', '', 'oplMIwm_9I21V0fz4m2HWkhiuOTA', '黄嘉仪', 1, 1, '', '', '', '304290034@qq.com', 2, 5, '', '', '', '/upload/user/mp/2016-07-11/57830ad43ebee.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 10:56:53', '2016-07-11 11:26:18'),
	(26, '18802684325', '94cbc5b7e4333663dde4', NULL, '', '', '吴壮凌', 1, 1, '', '侰汉控股(深圳)有限公司', '项目经理', 'wuzhuangling@chinama.club', 1, 19, '', '', '', '/upload/user/mp/2016-07-11/5783267c98c73.jpg', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 12:54:25', '2016-07-11 12:55:48'),
	(27, '13828817061', '0c323a5f13a14de84429', 'oglBHw9zVzzJEVtvJod8ql3qwGPU', '', 'oplMIwuAMLxO8nyk691lAHJFJzAg', '古思娜', 1, 1, '', '并购菁英汇', '', 'sir*a@chinama.club', 2, 20, '', '', '', '/upload/user/mp/2016-07-11/57835fa09a189.png', '/upload/user/avatar/2016-07-11/thumb_5783647939e2e.png', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 15:33:08', '2016-07-11 17:18:49'),
	(28, '13631506288', 'bfd5d806303db6378cf4', 'oglBHwynTizSM_RugdynwIupLyt8', '', 'oplMIwsuRYNt290EfrrJlqdGT9xA', '周密', 1, 1, '', '并购著英汇', '合伙人', 'zhouml@chlnarna.club', 2, 29, '', '', '', '/upload/user/mp/2016-07-11/57834d60675f1.png', '/upload/user/avatar/2016-07-11/thumb_57835070d5d74.png', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 15:40:33', '2016-07-11 15:53:24'),
	(29, '13631610622', 'f99c97371b03f901dc85', 'oglBHw0v-3ZM66sS2bxtlPpjSk7c', '', 'oplMIwvXK_AiQbnao560FWyiRbJE', '闫梦', 1, 3, '', '并购菁英汇', '会务经理', 'yanmeng@chinama.club', 1, 5, '', '', '', '/upload/user/mp/2016-07-11/5783660f44d91.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 4, 1, 1, 1, 1, '2016-07-11 17:25:58', '2016-07-13 20:51:15'),
	(30, '15005903191', '261ddd57762ee15565dc', NULL, '', '', '鄢棽', 1, 2, '', '君汉控股(深圳)有限公司', '运营专员', 'yanshen@chinama.club', 1, 5, '', '', '', '/upload/user/mp/2016-07-12/578462b5020c3.jpg', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 3, 1, 1, 1, 1, '2016-07-12 11:24:07', '2016-07-13 16:29:11');
...
CREATE TABLE IF NOT EXISTS `user_industry` (
  ...
  `industry_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=75 DEFAULT CHARSET=utf8 COMMENT='用户行业标签';

-- 正在导出表  binggq.user_industry 的数据：~54 rows (大约)
