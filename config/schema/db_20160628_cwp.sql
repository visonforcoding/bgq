...
-- 正在导出表  binggq.actionlog 的数据：~42 rows (大约)
...
-- 正在导出表  binggq.activity 的数据：~10 rows (大约)
DELETE FROM `activity`;
/*!40000 ALTER TABLE `activity` DISABLE KEYS */;
INSERT INTO `activity` (`id`, `admin_id`, `user_id`, `publisher`, `industry_id`, `company`, `title`, `time`, `address`, `scale`, `read_nums`, `praise_nums`, `comment_nums`, `cover`, `body`, `summary`, `create_time`, `update_time`, `apply_nums`, `apply_fee`, `is_crowdfunding`, `is_check`, `is_top`, `guest`, `reason`, `region_id`) VALUES
	(6, 2, 8, '曹麦穗', 5, '柠檬智慧科技', 'E店通', '2016-09-09 12:00-13:00', '福田上沙3', '500人', 13, NULL, NULL, '/upload/activity/2016-04-21/571878d1d6f5f.jpg', '<p>活动介绍：</p><p><br/></p><p><br/></p><p>活动流程：</p><p><br/></p><p><br/></p><p>参与嘉宾：</p><p><br/></p><p><br/></p><p>联系方式：<br/></p>', '<p>交流会啊</p>', '2016-04-21 14:53:00', '2016-06-13 15:39:55', 0, 0, 0, 1, 0, NULL, NULL, 1),
...
CREATE TABLE IF NOT EXISTS `activitycom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='活动评论表';

-- 正在导出表  binggq.activitycom 的数据：~17 rows (大约)
...
CREATE TABLE IF NOT EXISTS `activity_industry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='活动标签对映表';

-- 正在导出表  binggq.activity_industry 的数据：~10 rows (大约)
...
-- 正在导出表  binggq.activity_savant 的数据：~0 rows (大约)
...
-- 正在导出表  binggq.admin 的数据：~0 rows (大约)
DELETE FROM `admin`;
/*!40000 ALTER TABLE `admin` DISABLE KEYS */;
INSERT INTO `admin` (`id`, `username`, `truename`, `password`, `phone`, `enabled`, `ctime`, `utime`, `login_time`, `login_ip`) VALUES
	(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-06-16 14:31:12', '2016-06-16 14:31:12', '127.0.0.1');
...
-- 正在导出表  binggq.adminmsg 的数据：~3 rows (大约)
...
-- 正在导出表  binggq.agency 的数据：~28 rows (大约)
DELETE FROM `agency`;
...
-- 正在导出表  binggq.banner 的数据：~6 rows (大约)
DELETE FROM `banner`;
...
-- 正在导出表  binggq.biggie_ad 的数据：~0 rows (大约)
...
-- 正在导出表  binggq.card_box 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `career` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='工作经历';
...
INSERT INTO `career` (`id`, `user_id`, `company`, `position`, `start_date`, `end_date`, `descb`, `create_time`, `update_time`) VALUES
	(5, 8, 'google', 'Google+', '2015-06-26', '2016-06-26', '学会了打dota', '2016-06-26 18:03:08', '2016-06-26 18:03:08');
...
-- 正在导出表  binggq.collect 的数据：~5 rows (大约)
DELETE FROM `collect`;
...
CREATE TABLE IF NOT EXISTS `comment_like` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='评论点赞表';

-- 正在导出表  binggq.comment_like 的数据：~20 rows (大约)
...
CREATE TABLE IF NOT EXISTS `flow` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户资金流水';
...
-- 正在导出表  binggq.industry 的数据：~20 rows (大约)
...
CREATE TABLE IF NOT EXISTS `like_logs` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '类型值：0：活动；1：资讯',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='点赞日志表';

-- 正在导出表  binggq.like_logs 的数据：~4 rows (大约)
...
-- 正在导出表  binggq.menu 的数据：~23 rows (大约)
DELETE FROM `menu`;
...
CREATE TABLE IF NOT EXISTS `newscom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='新闻评论表';

-- 正在导出表  binggq.newscom 的数据：~27 rows (大约)
DELETE FROM `newscom`;
...
-- 正在导出表  binggq.news_industry 的数据：~15 rows (大约)
...
-- 正在导出表  binggq.news_savant 的数据：~0 rows (大约)
...
INSERT INTO `order` (`id`, `type`, `relate_id`, `user_id`, `seller_id`, `order_no`, `out_trade_no`, `paytype`, `price`, `fee`, `remark`, `status`, `create_time`, `update_time`) VALUES
	...
	(7, 1, 8, 8, 7, '14667552538873', '', 1, 200.00, 0.00, '预约话题互联网开发讲座', 0, '2016-06-24 16:00:53', '2016-06-24 16:00:53'),
	(8, 1, 9, 8, 7, '14668239298913', '', 1, 200.00, 0.00, '预约话题互联网开发讲座', 0, '2016-06-25 11:05:29', '2016-06-25 11:05:29');
...
-- 正在导出表  binggq.projrong 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `savant` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `reco_nums` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '约见次数',
  ...
  `summary` varchar(550) DEFAULT NULL COMMENT '专家简介',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='专家信息表';

-- 正在导出表  binggq.savant 的数据：~2 rows (大约)
DELETE FROM `savant`;
/*!40000 ALTER TABLE `savant` DISABLE KEYS */;
INSERT INTO `savant` (`id`, `user_id`, `reco_nums`, `cover`, `xmjy`, `zyys`, `summary`) VALUES
	(3, 8, 1, '', '7年dota经验，精通所有英雄，5个位置都能打，擅长C位，伐木能力惊人！', 'dota 坑逼 菜鱼\n万年经济垫底飞鞋送人头 菜黄\n烈士路第一单 小金子\n中路菜鸡 左XX', ''),
	(5, 7, 1, '', '7年dota经验，精通所有英雄，5个位置都能打，擅长C位，伐木能力惊人！', 'dota 坑逼 菜鱼\n万年经济垫底飞鞋送人头 菜黄\n烈士路第一单 小金子\n中路菜鸡 左XX', '浪淘沙');
...
CREATE TABLE IF NOT EXISTS `savant_reco` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='专家推荐';

-- 正在导出表  binggq.savant_reco 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `smsmsg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='短信记录';

-- 正在导出表  binggq.smsmsg 的数据：~50 rows (大约)
DELETE FROM `smsmsg`;
...
INSERT INTO `smsmsg` (`id`, `phone`, `code`, `content`, `create_time`) VALUES
	...
	(51, '18316629973', '9437', '您的动态验证码为9437', '2016-06-21 16:30:35'),
	(52, '18316629973', '9752', '您的动态验证码为9752', '2016-06-21 16:32:48'),
	(53, '18316629973', '', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', '2016-06-24 16:00:54'),
	(54, '18681509040', '6836', '您的动态验证码为6836', '2016-06-24 20:55:15'),
	(55, '18316629973', '4760', '您的动态验证码为4760', '2016-06-24 20:59:37'),
	(56, '18316629973', '3626', '您的动态验证码为3626', '2016-06-24 21:18:56'),
	(57, '18316629973', '9799', '您的动态验证码为9799', '2016-06-24 21:44:02'),
	(58, '18316629973', '', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', '2016-06-25 11:05:30'),
	(59, '18316629973', '3092', '您的动态验证码为3092', '2016-06-27 10:09:26'),
	(60, '18316629973', '9831', '您的动态验证码为9831', '2016-06-27 10:09:27'),
	(61, '18316629973', '8304', '您的动态验证码为8304', '2016-06-27 10:10:07');
...
-- 正在导出表  binggq.sponsor 的数据：~0 rows (大约)
DELETE FROM `sponsor`;
...
CREATE TABLE IF NOT EXISTS `subject_book` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='话题预约';
...
INSERT INTO `subject_book` (`id`, `subject_id`, `user_id`, `savant_id`, `summary`, `status`, `create_time`, `update_time`) VALUES
	...
	(8, 3, 8, 7, '我有一个plan,只差一个coder，和一些money了。', 1, '2016-06-24 11:48:13', '2016-06-24 16:00:53'),
	(9, 3, 8, 7, 'dd12312', 1, '2016-06-25 10:41:22', '2016-06-25 11:05:29');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `phone` varchar(20) NOT NULL COMMENT '手机号',
  `user_token` varchar(50) NOT NULL COMMENT '用户标志',
  ...
  `gsyw` varchar(250) DEFAULT '' COMMENT '公司业务',
...
-- 正在导出表  binggq.user 的数据：~5 rows (大约)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `phone`, `user_token`, `union_id`, `wx_openid`, `app_wx_openid`, `truename`, `level`, `idcard`, `company`, `position`, `email`, `gender`, `agency_id`, `ext_industry`, `goodat`, `city`, `card_path`, `avatar`, `money`, `meet_nums`, `fans`, `ymjy`, `ywnl`, `gsyw`, `reason`, `status`, `savant_status`, `enabled`, `create_time`, `update_time`) VALUES
	(2, '', '', '', '', '', 'admin', '1', '', '', '', '', 1, 0, '', '', '', '', '', 0.00, 0, 0, '', '', '', '', 1, 1, 1, '0000-00-00 00:00:00', NULL),
	(7, '18681509041', '', '', '', '', '郑旭', '2', '', '中青文化投资管理有限公司', '互联网事业部副总经理', 'claus@smartlemon.cn', 1, 17, '6642', '', '', '/upload/user/mp/2016-05-05/572b2466c4068.jpg', '/upload/user/avatar/avatar2.jpg', 300.00, 0, 1, '', '', '', '', 2, 1, 1, '2016-05-05 18:46:01', '2016-06-13 17:00:30'),
	(8, '18316629973', '5760b3d3207fc', 'oglBHw-G5fbNmQeUoZiyWl_M1Dgc', 'oqQRxsx_srEukkVOBQMVWsmPDPbY', 'oplMIwnDMBxytRnkyYXcTE2J6JSE', '曹麦穗', '2', '', '广东深宏盾律师事务所', '共产主义接班人', '714265403@qq.com', 2, 13, '打dota', '4445', '', '/upload/user/mp/2016-05-09/57305f00c5c1a.jpg', '/upload/user/avatar/2016-06-26/thumb_576f506d177be.jpg', 300.00, 0, 1, '', '', '776gjhi8g33edxfh', '', 2, 3, 1, '2016-05-09 17:57:24', '2016-06-27 09:51:57'),
	(9, '13560627825', '', '', '', '', '游依婷', '1', '', '广东深宏盾律师事务所', '', '71426333x@qq.com', 1, 28, '', '', '', '/upload/user/mp/2016-05-11/573312fbdeaa3.jpg', '', 0.00, 0, 0, '', '', '', '', 1, 1, 1, '2016-05-11 19:10:58', '2016-05-11 19:20:01'),
	(10, '13510663507', '', '', '', '', '周啸风', '1', '', '', '副总裁', 'xifeo@smartlemon.cn', 1, 5, '', '', '', '/upload/user/mp/2016-06-07/5756bee45c3ac.jpg', '', 0.00, 0, 0, '', '', '', '', 1, 1, 1, '2016-06-07 20:32:48', '2016-06-07 20:33:20');
...
CREATE TABLE IF NOT EXISTS `usermsg` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='用户消息';

-- 正在导出表  binggq.usermsg 的数据：~27 rows (大约)
DELETE FROM `usermsg`;
...
INSERT INTO `usermsg` (`id`, `user_id`, `type`, `table_id`, `title`, `msg`, `num`, `url`, `status`, `create_time`, `update_time`) VALUES
	...
	(38, 7, 4, 8, '话题预约', '您有新的话题预约请求', 0, '/home/my-book-savant', 0, '2016-06-24 11:48:13', '2016-06-24 11:48:13'),
	(39, 8, 4, 8, '预约通知', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', 0, '/home/my-book-savant', 0, '2016-06-24 16:00:54', '2016-06-24 16:00:54'),
	(40, 7, 4, 9, '话题预约', '您有新的话题预约请求', 0, '/home/my-book-savant', 0, '2016-06-25 10:41:22', '2016-06-25 10:41:22'),
	(41, 8, 4, 9, '预约通知', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', 0, '/home/my-book-savant', 0, '2016-06-25 11:05:30', '2016-06-25 11:05:30');
...
-- 正在导出表  binggq.user_fans 的数据：~2 rows (大约)
...
CREATE TABLE IF NOT EXISTS `user_industry` (
  ...
  `industry_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='用户行业标签';

-- 正在导出表  binggq.user_industry 的数据：~11 rows (大约)
