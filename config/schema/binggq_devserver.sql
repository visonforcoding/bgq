...
--
-- Host: localhost
-- Generation Time: 2016-06-15 10:13:24
-- 服务器版本： 5.5.37-log
-- PHP Version: 5.6.21
...
--
ALTER TABLE `actionlog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键，自增',AUTO_INCREMENT=43;
--
...
--
ALTER TABLE `comment_like`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '评论点赞表',AUTO_INCREMENT=26;
--
...
--
ALTER TABLE `newscom`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '新闻评论表',AUTO_INCREMENT=36;
--
