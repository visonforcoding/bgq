...
CREATE TABLE IF NOT EXISTS `actionlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志表';
...
INSERT INTO `admin` (`id`, `username`, `truename`, `password`, `phone`, `enabled`, `ctime`, `utime`, `login_time`, `login_ip`) VALUES
	(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-05-13 10:33:29', '2016-05-13 10:33:29', '127.0.0.1');
...
-- 正在导出表  binggq.news 的数据：~2 rows (大约)
DELETE FROM `news`;
...
-- 正在导出表  binggq.savant 的数据：~1 rows (大约)
DELETE FROM `savant`;
...
INSERT INTO `user` (`id`, `phone`, `wx_openid`, `truename`, `level`, `idcard`, `company`, `position`, `email`, `gender`, `agency_id`, `ext_industry`, `goodat`, `city`, `card_path`, `avatar`, `money`, `meet_nums`, `ymjy`, `ywnl`, `reason`, `status`, `savant_status`, `enabled`, `create_time`, `update_time`) VALUES
	(7, '18681509040', '', '郑旭', '2', '', '中青文化投资管理有限公司', '互联网事业部副总经理', 'claus@smartlemon.cn', 1, 17, '6642', '', '', '/upload/user/mp/2016-05-05/572b2466c4068.jpg', '', 0.00, 0, '', '', '', 2, 1, 1, '2016-05-05 18:46:01', '2016-05-13 12:51:17'),
	(8, '18316629973', 'ogD3IwZkB0fiIdrRDPwn_ao9mMBA', '曹麦穗', '2', '', '广东深宏盾律师事务所', '共产主义接班人', '714265403@qq.com', 1, 13, '打dota', '', '', '/upload/user/mp/2016-05-09/57305f00c5c1a.jpg', 'http://wx.qlogo.cn/mmopen/ajNVdqHZLLCOibYvNGzNtJmgyOEpAyhkd45A3gbGgt2mbDYUdMeBVbbe9SmxwJiceNGd4ibZCeKTHSDq1kJDkVibXQ/0', 0.00, 0, '', '', '', 2, 3, 1, '2016-05-09 17:57:24', '2016-05-13 17:43:16'),
	(9, '13560627825', '', '游依婷', '1', '', '广东深宏盾律师事务所', '', '71426333x@qq.com', 1, 28, '', '', '', '/upload/user/mp/2016-05-11/573312fbdeaa3.jpg', '', 0.00, 0, '', '', '', 1, 1, 1, '2016-05-11 19:10:58', '2016-05-11 19:20:01');
