...
CREATE TABLE IF NOT EXISTS `actionlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志表';

-- 正在导出表  binggq.actionlog 的数据：~12 rows (大约)
...
INSERT INTO `admin` (`id`, `username`, `truename`, `password`, `phone`, `enabled`, `ctime`, `utime`, `login_time`, `login_ip`) VALUES
	(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-04-26 09:59:32', '2016-04-26 09:59:32', '127.0.0.1');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `phone` varchar(20) NOT NULL COMMENT '手机号',
  `wx_openid` varchar(20) DEFAULT NULL COMMENT '微信的openid',
...
INSERT INTO `user` (`id`, `phone`, `wx_openid`, `pwd`, `truename`, `level`, `idcard`, `company`, `position`, `email`, `gender`, `industry_id`, `goodat`, `city`, `card_path`, `avatar`, `money`, `ymjy`, `ywnl`, `reason`, `status`, `create_time`, `update_time`) VALUES
	(2, '18316629973', NULL, '$2y$10$ZhwqXf41YVWVTZ3am.Uof.dzSn9myss903kZQ1VJQGBIrstq/NYTK', '曹文鹏', '1', '', '', '', '', 1, 3, '', NULL, '123', '', 1.00, '', '', '', 1, '2016-04-19 16:35:17', '2016-04-19 16:35:17');
