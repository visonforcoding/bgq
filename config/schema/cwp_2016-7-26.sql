...
-- 导出 binggq 的数据库结构
DROP DATABASE IF EXISTS `binggq`;
...
CREATE TABLE IF NOT EXISTS `actionlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=170 DEFAULT CHARSET=utf8 CHECKSUM=1 ROW_FORMAT=DYNAMIC COMMENT='后台操作日志表';
...
CREATE TABLE IF NOT EXISTS `activity` (
  ...
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `apply_end_time` datetime NOT NULL COMMENT '报名截止日期',
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='活动表';

-- 正在导出表  binggq.activity 的数据：~22 rows (大约)
DELETE FROM `activity`;
/*!40000 ALTER TABLE `activity` DISABLE KEYS */;
INSERT INTO `activity` (`id`, `admin_id`, `user_id`, `publisher`, `industry_id`, `company`, `title`, `time`, `address`, `scale`, `read_nums`, `praise_nums`, `comment_nums`, `cover`, `body`, `summary`, `create_time`, `apply_end_time`, `update_time`, `apply_nums`, `apply_fee`, `is_crowdfunding`, `is_check`, `is_top`, `from_user`, `guest`, `reason`, `series_id`, `region_id`, `qrcode`, `thumb`) VALUES
	(6, 2, 8, '曹麦穗', 5, '柠檬智慧科技', 'E店通', '2016-09-09 12:00-13:00', '福田上沙3', '500人', 24, NULL, NULL, '/upload/activity/2016-04-21/571878d1d6f5f.jpg', '<p>活动介绍：</p><p><br/></p><p><br/></p><p>活动流程：</p><p><br/></p><p><br/></p><p>参与嘉宾：</p><p><br/></p><p><br/></p><p>联系方式：<br/></p>', '<p>交流会啊</p>', '2016-04-21 14:53:00', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 0, 0, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/14678966196.png', NULL),
	(8, 2, 2, '曹麦穗', 0, '并购精英汇', '2006年中国国际体育融资总裁年会', '04月28日-04月30日', '深圳市福田区东海国际公寓', '500人', 54, 2, 7, '/upload/newscover/2016-06-07/575689ec1146c.png', '<p>活动流程：<br/></p><p>13:00 - 14:00&nbsp;签到</p><p>13:00 - 14:00&nbsp;活动开场</p><p>14:00 - 14:05&nbsp;签到</p><p>14:05 - 14:15&nbsp;天天投介绍</p><p>14:15 - 14:55&nbsp;圆桌论坛+现场提问</p><p>14:55 - 16:40&nbsp;12个项目路演</p><p>14:40 - 18:00&nbsp;投融资面对面一对一交流</p><p>18:00 - 00:00&nbsp;活动结束</p><p><br/></p>', '<p>46号文的出现，体育产业从业界内心激情澎湃，产业外人士 纷纷扎入，这是体育产业建仓的最好时候，那么接下来体育 与资本、体育金融、体育产业将如何风起云涌？谁将是体育 产业中的新星？谁将成为体育产业里的独角兽？</p>', '2016-06-07 16:46:00', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 0, 0, 0, 1, 0, 0, '<p>高一波 柠檬智慧总裁</p><p>郑旭 柠檬智慧副总裁</p><p><br/></p>', NULL, 0, 2, '/upload/qrcode/activitycode/2016-07-07/14678966208.png', NULL),
	(9, 2, 2, '曹麦穗', 0, '并购精英汇', '云峰有约——刘云中国画作品展', '2016.6.7~6.12 (逢周一休馆）', '深圳市福田区红荔路6026号', '100人', 15, NULL, NULL, '/upload/newscover/2016-06-07/57569682a7e94.jpg', '<p>活动：</p><p style="margin-top: 0px; margin-bottom: 0px; padding: 5px 0px; word-wrap: break-word; line-height: 26px; font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; color: rgb(34, 34, 34); white-space: normal; background-color: rgb(255, 255, 255);"><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; background-color: rgb(255, 255, 255);">中、西绘画艺术语言的融汇贯通是20世纪以来中国画家寻求现代转型和世界对话的一个重要路径，而由油画跨入中国画的大家如徐悲鸿、朱屹瞻、林风眠、李可染、吴冠中等都以其辉煌的艺术成就，为中、西绘画艺术的融合、对话、碰撞而产生全新的艺术风格提供了典范。他们作为一种现代艺术精神和思想资源，感召着后来者，也为后来者奠定了继续探索前行的基石，从而构成了现代中国画艺术的多元面貌。</span></p>', '<p>“云峰有约——刘云中国画作品展”将于2016年6月7日上午10：00在深圳市关山月美术馆开幕，此展由中国美术家协会、湖南省文学艺术界联合会共同主办，关山月美术馆、湖南省美术家协会、湖南省画院、湖南美术出版社联合承办，共展出刘云山水画作品70件。</p>', '2016-06-07 17:37:00', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 0, 0, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/14678966209.png', NULL),
	(10, 2, 2, '曹麦穗', 0, '南澳办事处', '6月8日来南澳看海上赛龙舟，品疍家渔民文化', '2016年6月8日 周三 9:00', '大鹏新区南澳月亮湾海域', '1000人', 97, 3, 4, '/upload/newscover/2016-06-07/575697402e545.jpg', '<p>活动：</p><p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; background-color: rgb(255, 255, 255);">“赛龙舟百舸争流 舞腰鼓万人同欢”。一年一度的大鹏新区南澳龙舟邀请赛将于6月8日上午9时在南澳月亮湾海域举行。届时将有来自广州、东莞、香港、澳门和深圳的18支队伍海上竞渡。</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; background-color: rgb(255, 255, 255);">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 作为南澳的旅游文化名片之一，今年，南澳办事处着重“打造品牌”，聘请专业公司设计了龙舟赛LOGO，通过标志鲜明的精彩赛事和文艺汇演，将龙舟赛打造成弘扬南澳文化的特色品牌。</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; white-space: normal; background-color: rgb(255, 255, 255);"/><br/></p>', '<p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 26px; background-color: rgb(255, 255, 255);">南澳作为龙舟之乡，赛龙舟已有70多年的历史，至今已成功举办15届。作为广东省非物质文化遗产项目，龙舟文化已深入本地居民的生活，更成为备受社会关注的国际性运动。同时，南澳的祭妈祖、渔民娶', '2016-06-07 17:43:00', '0000-00-00 00:00:00', '2016-07-12 11:14:04', 1, 0, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/146789662010.png', NULL),
	(11, 2, 2, '曹麦穗', 0, '网易娱乐', '2016深圳CFD暴雪电竞嘉年华活动 端午节期间上演', '6月9日-11日', '深圳龙岗大运中心体育馆', '500人', 42, 2, 1, '/upload/newscover/2016-06-07/575699cb52d91.png', '<p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">交通指南</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">　　公交：</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">　　附近公交站：大运中心、体育新城、大运中心体育场</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">　　地铁：3号龙岗线大运站C出口</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">　　地铁到站出站以后，到附近的地铁公交接驳站坐公交。</span></p>', '<p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">狼蛛杯CFD暴雪电竞嘉年华是由网易和暴雪授权、CFD电竞平台举办的《风暴英雄》和《炉石传说》官方赛事，是广大游戏玩家参与的电竞盛典。</span></p>', '2016-06-07 17:54:00', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 0, 0, 0, 1, 0, 0, NULL, NULL, 0, 2, '/upload/qrcode/activitycode/2016-07-07/146789662011.png', NULL),
	(12, 2, 2, '曹麦穗', 0, '深圳交响乐团', '【公益活动】深圳交响乐团音乐季音乐会导赏', '2016年6月9日（周四）14:30', '深圳交响乐团演奏厅（深圳市罗湖区黄贝路2025号）', '100人', 87, 4, 1, '/upload/newscover/2016-06-07/57569c5069697.jpg', '<p><span style="color: rgb(128, 0, 128); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">公益免费，凭身份证领取入场票</span></p>', '<p><span style="color: rgb(128, 0, 128); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">公益免费，凭身份证领取入场票</span></p>', '2016-06-07 18:05:00', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 1, 0, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/146789662012.png', NULL),
	(13, 2, 2, '曹麦穗', 0, '福田文化馆', '【公益演出】黄龙戏小戏赏析', '2016年6月10日 7:00-8:30', '福田区非遗馆剧场（二楼小剧场）', '100人', 69, 1, NULL, '/upload/newscover/2016-06-07/5756a02b93e45.jpg', '<p><span style="font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; color: rgb(255, 140, 0); background-color: rgb(255, 255, 255);"><strong>《梨园苹果》</strong></span><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">剧情简介戏曲剧团龙套演员李大平受儿子李小果学校之托，要去学校组织的联欢会上表演节目。一口答应在联欢会唱歌的他，却在剧团的排练场偷偷地拿出团里的传统戏曲服装自己排练起了戏曲唱段的节目。学校教导处主任在李小果的带领下审查李大平的节目，几次劝说让他放弃表演戏曲唱段，改为唱流行歌曲《小苹果》，并表示现在不光是孩子们，就算是很多成年人也不愿意接受节奏缓慢咿咿呀呀的戏曲表演艺术。李大平几次“抗争”无果之后，稍作妥协，把戏曲唱段的唱词用流行歌曲的形式表演出来。王主任和李小果看后拍手叫好，李大平却从掌声中失落无比脱下了他梦寐以求的主演服装，他觉得自己虽然只是个剧团里的小龙套，但戏曲不可以这样改革，艺术不可以这样胡闹，从而拒绝了联欢会的邀约。最后王主任幡然醒悟，觉得不光戏曲应该更加贴近观众，观众也应该平静下心来去更深层次的了解戏曲，不仅答应让李大平在联欢会上表演戏曲唱段，而且邀请剧团老师把戏曲艺术带进校园，每周去给学生们上一节戏曲课程。</span></p><p><span style="font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; color: rgb(255, 140, 0); background-color: rgb(255, 255, 255);"><strong>《醉鬼相亲》</strong></span><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">剧情简介嗜酒为命、无所事事的东北农村大龄亲年何老九受远房表叔牵线搭桥，醉酒后来到表叔家相看对象，谁知前来相亲的农村大龄剩女刘美妞（反串）貌丑无比、说话莽撞。二人在交流对话中一醉酒，一莽撞，火花四溅，笑料不断。最后刘美妞道出儿时旧事，原来二人早有渊源。刘美妞虽貌丑莽撞，但淳朴勤劳；何老九嗜酒如命，却也是宅心仁厚。二人的碰撞能否给彼此带来自我认知的改变，每个人心里都有不同的答案。</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">《醉鬼相亲》是东北地方小戏常见的调侃嬉闹的表演风格。在热闹之余，讽刺了当下农村的恶风陋习，同时也表达了不管什么样的人对美好生活的由衷渴求。</span></p>', '<p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">这是舞台上不多见的以戏说戏的表演形式，用当代戏曲人和当代大多数观众两个视角来表述戏曲艺术如今存在的困惑和问题。它不会给予答案，只期望带给更多的人一些思考。</span></p>', '2016-06-07 18:20:00', '0000-00-00 00:00:00', '2016-07-11 11:12:24', 2, 0.01, 0, 1, 0, 0, NULL, NULL, 0, 2, '/upload/qrcode/activitycode/2016-07-07/146789662013.png', NULL),
	(14, 2, 2, '曹麦穗', 0, '政府', '《梅花三弄》——经典古筝名曲赏析端午节音乐会', '2016年6月10日（周五）15:00', '深圳大剧院音乐厅', '100人', 179, 3, 1, '/upload/newscover/2016-06-07/5756a12e4eccc.jpg', '<p><strong style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);">演出曲目</strong><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">梅花三弄&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 陈志远/曲</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">茉莉芬芳&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 何占豪/曲</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">临安遗恨&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 何占豪/曲</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">牧羊曲&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 王立平/曲</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">梁祝&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 何占豪/曲</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">彝族舞曲&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 王中山/改编&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">水调歌头•明月几时有</span><br style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; white-space: normal; background-color: rgb(255, 255, 255);"/><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">秋望&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 周煜国/曲</span></p>', '<p><span style="color: rgb(34, 34, 34); font-family: &#39;Microsoft Yahei&#39;, 黑体, Tahoma, SimSun; line-height: 28px; background-color: rgb(255, 255, 255);">古筝是我国传统民族乐器，它是中国独特的、重要的民族乐器之一。它的音色优美，音域宽广、演奏技巧丰富，具有相当强的表现力，因此它深受广大人民群众的喜爱。6月10日端午节假期，深圳“艺术大观', '2016-06-07 18:25:00', '0000-00-00 00:00:00', '2016-07-08 11:24:51', 1, 0.01, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/146789662014.png', NULL),
	(15, 2, 2, '曹麦穗', 0, '西西弗书店', '鞠萍姐姐携新书《萍聚》于花园城前庭与你见面', '6月11日（周六）16:30-18:30', '深圳市南山区南海大道花园城（购物中心）1楼前庭', '100人', 399, 4, 29, '/upload/activitycover/2016-07-08/577f430ed8fbf.png', '<p>年少时，陪伴我们鞠萍姐姐，依然继续陪伴着更多的儿童以及青少年。小编似乎觉得，好像时光并没有流失，因为鞠萍姐姐还是记忆中的鞠萍姐姐啊，跟小编小时候看见的一样。或许岁月改变的是彼此的容颜，却没有改变我们的记忆。</p><p>童年喜欢鞠萍姐姐的小伙伴们，现在孩子喜欢鞠萍姐姐的朋友们，还有喜欢鞠萍姐姐新书《萍聚》的朋友们，一起来花园城参加鞠萍姐姐读者见面会吧。让我们一起用爱守护童年，用心撒播希望。6月11日，我们不见不散~</p>', '<p>小时候，每天下午放学回家，第一件事就是打开电视机，从动画城看到大风车，从大风车看到七巧板，董浩叔叔，鞠萍姐姐，小鹿姐姐，金龟子，月亮姐姐每个人都能叫出名字来，就好像他们就是我们童年的偶</p>', '2016-06-07 18:40:00', '0000-00-00 00:00:00', '2016-07-12 14:42:57', 3, 0, 0, 1, 0, 0, NULL, NULL, 0, 2, '/upload/qrcode/activitycode/2016-07-07/146789662015.png', '/upload/activitythumb/2016-07-08/577f430ab6481.png'),
	(19, 0, 11, '', 0, '柠檬智慧咨询有限公司', '我们实得分 ', '', '', '', NULL, NULL, NULL, NULL, '窝窝', NULL, '2016-07-04 09:33:33', '0000-00-00 00:00:00', '2016-07-07 21:03:40', 0, 0, 1, 0, 0, 0, NULL, NULL, 0, 0, '/upload/qrcode/activitycode/2016-07-07/146789662019.png', NULL),
	(20, 2, 2, '曹麦穗', 0, '并购菁英汇', '互联网＋行业峰会', '2016-09-09', '万象城', '100人', 146, 1, 3, '/upload/activitycover/2016-07-08/577f1866232c6.jpg', '<p>如果问如今中国哪个行业最火？毫无疑问，必然是IT互联网行业。在“互联网+”的热潮下，互联网创造了一个又一个的跨界奇迹，制造了一个又一个的行业神话。</p>', '<p>从最初的电商颠覆零售，到如今的互联网+在餐饮、旅游、物流、地产、医疗……等多个行业发力，形成了一股来势汹涌的互联网热潮。互联网IT行业以其蓬勃兴起的无尽活力向世人昭示了信息技术的强大生命力！</p>', '2016-07-05 14:38:40', '0000-00-00 00:00:00', '2016-07-12 15:32:28', 5, 0, 0, 1, 0, 0, '<p><embed id="xunlei_com_thunder_helper_plugin_d462f475-c18e-46be-bd10-327458d045bd" type="application/thunder_download_plugin" height="0" width="0"/></p><p><br/></p>', NULL, 0, 2, '/upload/qrcode/activitycode/2016-07-07/146789662020.png', '/upload/activitythumb/2016-07-08/577f18db31f35.jpg'),
	(21, 2, 2, '曹麦穗', 0, '并购精英汇', '2016年中国国际体育融资总裁年会', '2016年6月8日 周三 9:00', '岗厦北', '100人', 120, 1, NULL, '/upload/activitycover/2016-07-08/577f19f65619e.png', '<p>1月22 日，体育BANK联合安信证券、君联资本、华体集团、探路者、智美体育集团、通力律师事务所、北京鸟巢文化中心在鸟巢举办了“2016中国国际体育投融资总裁年会暨首届“体育BANK”颁奖盛典。来自体育各界上市公司、投资机构、体育新三板公司、学术界、金融界的专家和领导共200余人莅临会场，与2015年度体育产业年度最佳获奖者们，共同见证了这一体育与资本拥抱的年度体育盛事。</p>', '<p><strong>时间</strong>：2016 年1月22日 14:00-20:00</p><p><strong>地点</strong>：北京鸟巢文化中心</p><p><strong>主题</strong>：体育大时代，悟动未来</p><p><strong>组织机构 </strong>&nbsp; &nbsp;</p><p><strong>主办方</strong>：体育BANK、安信证券、君联资本、华体集团、探路者、智美集团、通力律师事务所 &nbsp; &nbsp;</p><p>&am', '2016-07-05 16:07:01', '0000-00-00 00:00:00', '2016-07-12 15:35:14', 3, 0, 0, 1, 0, 0, NULL, NULL, 0, 1, '/upload/qrcode/activitycode/2016-07-07/146789662021.png', '/upload/activitythumb/2016-07-08/577f19f1ab5d9.png'),
	(24, 2, 2, '曹麦穗', 0, '并购帮', '并购万里行—为金融垂直领域精英人才的工作学习', '2016-09-09 12:00-13:00', '南山区', '100', 159, 2, 5, '/upload/activitycover/2016-07-08/577f0d383137e.jpg', '<p>是一个专注并购的菁英社交平台,致力于搭建中国最顶尖的金融精英社区,为金融垂直领域精英人才的工作学习,事业社交以及休闲生活提供高端,精准服务。</p>', '<p>是一个专注并购的菁英社交平台,致力于搭建中国最顶尖的金融精英社区,为金融垂直领域精英人才的工作学习,事业社交以及休闲生活提供高端,精准服务。</p>', '2016-07-08 10:18:21', '0000-00-00 00:00:00', '2016-07-12 16:08:48', 8, 100, 0, 1, 0, 0, '', NULL, 0, 2, 'upload/qrcode/activitycode/2016-07-08/146794433424.png', '/upload/activitythumb/2016-07-08/577f0d32d995e.jpg'),
	(26, 2, 2, '曹麦穗', 0, '腾讯科技', '完成灸疗店铺版开发', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-14/57875092125a4.jpg', '<p>流程介绍：</p><p>test<br/></p><p><br/></p><p>联系方式：</p><p>testa<br/></p>', '<p>teaadfga</p><p>agd<br/></p>', '2016-07-14 16:43:29', '0000-00-00 00:00:00', '2016-07-14 16:43:29', 0, 100, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, '/upload/activitythumb/2016-07-14/578750830ffa4.jpg'),
	(27, 2, 2, '曹麦穗', 0, '腾讯科技', '完成灸疗店铺版开发', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-14/57875092125a4.jpg', '<p>流程介绍：</p><p>test<br/></p><p><br/></p><p>联系方式：</p><p>testa<br/></p>', '<p>teaadfga</p><p>agd<br/></p>', '2016-07-14 16:43:37', '0000-00-00 00:00:00', '2016-07-14 16:43:37', 0, 100, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, '/upload/activitythumb/2016-07-14/578750830ffa4.jpg'),
	(28, 2, 2, '曹麦穗', 0, '腾讯科技', '母婴健康交流', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-15/5788674c1bbe7.jpg', '<p>流程介绍：</p><p><br/></p><p>3<br/></p><p>联系方式：</p><p><br/></p><p>4<br/></p>', '<p>112<br/></p>', '2016-07-15 12:59:55', '0000-00-00 00:00:00', '2016-07-15 12:59:55', 0, 100, 0, 0, 0, 0, NULL, NULL, 1, 1, NULL, '/upload/activitythumb/2016-07-15/5788674400a98.jpg'),
	(29, 2, 2, '曹麦穗', 0, '腾讯科技', '母婴健康交流', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '', '<p>流程介绍：</p><p><br/></p><p><br/></p><p>联系方式：<br/></p>', NULL, '2016-07-15 14:14:34', '0000-00-00 00:00:00', '2016-07-15 14:14:34', 0, 100, 0, 0, 0, 0, NULL, NULL, 1, 1, NULL, ''),
	(30, 2, 2, '曹麦穗', 0, '腾讯科技', '这才是国内八月最值得去的12个旅行天堂！别去错了！', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-15/57887f96d4e82.jpg', '<p>流程介绍：</p><p>444<br/></p><p><br/></p><p>联系方式：</p><p>5556<br/></p>', '<p>333<br/></p>', '2016-07-15 14:16:09', '0000-00-00 00:00:00', '2016-07-15 14:16:09', 0, 200, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, '/upload/activitythumb/2016-07-15/57887f923e545.jpg'),
	(31, 2, 2, '曹麦穗', 0, '腾讯科技', '母婴健康交流', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-15/578881093b3f9.jpg', '<p>流程介绍：</p><p>123<br/></p><p><br/></p><p>联系方式：</p><p>123<br/></p>', '<p>3<br/></p>', '2016-07-15 14:22:10', '0000-00-00 00:00:00', '2016-07-15 14:22:10', 0, 100, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, '/upload/activitythumb/2016-07-15/578881045a35a.jpg'),
	(32, 2, 2, '曹麦穗', 0, 'google', '母婴健康交流', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '', '<p>流程介绍：</p><p><br/></p><p>3<br/></p><p>联系方式：</p><p>44<br/></p>', '<p>123<br/></p>', '2016-07-15 14:25:25', '0000-00-00 00:00:00', '2016-07-15 14:25:25', 0, 100, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, ''),
	(33, 2, 2, '曹麦穗', 0, '腾讯科技', '母婴健康交流', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-15/578882d4af322.jpg', '<p>流程介绍：</p><p><br/></p><p>3<br/></p><p>联系方式：</p><p>5<br/></p>', '<p>12<br/></p>', '2016-07-15 14:29:56', '0000-00-00 00:00:00', '2016-07-15 14:53:56', 0, 100, 0, 0, 0, 0, NULL, NULL, 3, 1, NULL, '/upload/activitythumb/2016-07-15/578882cf161c4.jpg'),
	(34, 2, 2, '曹麦穗', 0, 'google', '完成灸疗店铺版开发', '2016-09-09 12:00-13:00', '深圳市南山区腾讯大厦', '500人', NULL, NULL, NULL, '/upload/activitycover/2016-07-15/5788833c57504.jpg', '<p>流程介绍：</p><p><br/></p><p>123<br/></p><p>联系方式：</p><p>123<br/></p>', '<p>123<br/></p>', '2016-07-15 14:31:37', '0000-00-00 00:00:00', '2016-07-26 17:22:47', 0, 100, 0, 0, 0, 0, NULL, NULL, 0, 1, NULL, '/upload/activitythumb/2016-07-15/578883350ded4.jpg'),
	(35, 0, 29, '', 0, '12', '我有一个plan', '', '', '', NULL, NULL, NULL, NULL, '只差一个程序员', NULL, '2016-07-22 20:58:38', '0000-00-00 00:00:00', '2016-07-22 20:58:38', 0, 0, 1, 0, 0, -1, NULL, NULL, 0, 0, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `activityapply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='活动申请表';

-- 正在导出表  binggq.activityapply 的数据：~30 rows (大约)
DELETE FROM `activityapply`;
/*!40000 ALTER TABLE `activityapply` DISABLE KEYS */;
INSERT INTO `activityapply` (`id`, `user_id`, `activity_id`, `create_time`, `update_time`, `is_pass`, `is_top`, `is_sign`) VALUES
	(1, 10, 15, '2016-06-22 14:53:25', '2016-06-22 14:53:25', 0, 0, 0),
	(2, 10, 16, '2016-06-22 14:54:04', '2016-06-22 14:54:04', 0, 0, 0),
	(3, 9, 16, '2016-06-22 14:56:11', '2016-07-11 14:57:32', 0, 0, 0),
	(4, 9, 15, '2016-06-22 14:56:30', '2016-06-22 14:56:30', 0, 0, 0),
	(5, 10, 13, '2016-06-22 15:15:09', '2016-06-22 15:15:09', 0, 0, 0),
	(6, 9, 13, '2016-06-23 16:05:53', '2016-06-23 16:54:31', 1, 0, 0),
	(7, 10, 12, '2016-06-26 15:34:06', '2016-06-26 15:34:06', 0, 0, 0),
	(8, 11, 16, '2016-06-28 09:25:21', '2016-06-28 09:25:21', 0, 0, 0),
	(9, 9, 14, '2016-06-30 22:15:03', '2016-06-30 22:15:03', 0, 0, 0),
	(10, 11, 10, '2016-07-01 12:12:46', '2016-07-01 12:12:46', 0, 0, 0),
	(11, 7, 16, '2016-07-05 10:51:04', '2016-07-05 14:53:34', 1, 0, 0),
	(12, 7, 15, '2016-07-05 10:51:53', '2016-07-05 10:51:53', 0, 0, 0),
	(13, 7, 21, '2016-07-05 16:16:25', '2016-07-05 16:16:25', 0, 0, 0),
	(14, 17, 20, '2016-07-05 16:43:24', '2016-07-05 16:43:24', 0, 0, 0),
	(15, 14, 24, '2016-07-09 12:52:04', '2016-07-09 12:52:04', 0, 0, 0),
	(16, 14, 16, '2016-07-09 13:02:35', '2016-07-09 13:02:35', 0, 0, 0),
	(17, 24, 24, '2016-07-09 21:12:56', '2016-07-09 21:12:56', 0, 0, 0),
	(18, 25, 24, '2016-07-11 11:10:09', '2016-07-11 11:10:09', 0, 0, 0),
	(19, 25, 20, '2016-07-11 11:10:39', '2016-07-11 11:10:39', 0, 0, 0),
	(20, 26, 21, '2016-07-11 12:59:37', '2016-07-11 12:59:37', 0, 0, 0),
	(21, 7, 24, '2016-07-11 15:50:25', '2016-07-11 15:50:25', 0, 0, 0),
	(22, 27, 24, '2016-07-11 15:56:19', '2016-07-11 15:56:19', 0, 0, 0),
	(23, 26, 16, '2016-07-11 15:58:46', '2016-07-11 15:58:46', 0, 0, 0),
	(24, 7, 20, '2016-07-11 16:24:46', '2016-07-11 16:24:46', 0, 0, 0),
	(25, 13, 24, '2016-07-11 16:25:21', '2016-07-11 16:25:21', 0, 0, 0),
	(26, 26, 20, '2016-07-11 16:25:58', '2016-07-11 16:25:58', 0, 0, 0),
	(27, 24, 20, '2016-07-11 16:30:32', '2016-07-11 16:30:32', 0, 0, 0),
	(28, 10, 21, '2016-07-12 10:41:12', '2016-07-12 10:41:12', 0, 0, 0),
	(29, 9, 24, '2016-07-12 12:12:19', '2016-07-12 12:12:19', 0, 0, 0),
	(30, 15, 24, '2016-07-12 14:19:22', '2016-07-12 14:19:22', 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `activitycom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='活动评论表';
...
INSERT INTO `activitycom` (`id`, `user_id`, `activity_id`, `body`, `praise_nums`, `create_time`, `reply_id`, `pid`) VALUES
	...
	(21, 9, 16, '123', 4, '2016-06-25 16:42:00', 2, 0),
	...
	(26, 10, 8, '动画啊', 2, '2016-06-30 11:40:51', 2, 0),
	(27, 2, 11, '很严重', 0, '2016-07-01 10:08:11', 2, 0),
	(28, 11, 10, 'hjbbvb', 2, '2016-07-01 12:12:32', 2, 0),
	(29, 20, 15, '有见地', 0, '2016-07-04 20:30:18', 11, 19),
	(30, 7, 8, '', 1, '2016-07-05 10:27:22', 2, 0),
	(31, 7, 8, '', 1, '2016-07-05 10:27:39', 2, 0),
	(32, 7, 8, '我', 0, '2016-07-05 10:27:53', 2, 0),
	(33, 7, 8, '我们的生活方式，我', 0, '2016-07-05 10:28:08', 2, 0),
	(34, 7, 8, '我们的生活方式，我', 0, '2016-07-05 10:28:19', 2, 0),
	(35, 7, 8, '我们的生活方式，我', 0, '2016-07-05 10:28:40', 2, 0),
	(36, 7, 10, '大家好', 1, '2016-07-05 20:55:34', 2, 0),
	(37, 7, 15, '大家好', 0, '2016-07-05 22:15:04', 2, 0),
	(38, 7, 15, '我说我说我说', 0, '2016-07-06 11:58:17', 2, 0),
	(39, 7, 15, '我说我说我说', 0, '2016-07-06 11:58:36', 2, 0),
	(40, 7, 15, '我说我说我说', 0, '2016-07-06 11:59:16', 2, 0),
	(41, 7, 15, '我说我说我说', 0, '2016-07-06 12:00:21', 2, 0),
	(42, 7, 15, '我说我说我说g f t y', 0, '2016-07-06 12:00:55', 2, 0),
	(43, 7, 15, '我说我说我说g f t y', 0, '2016-07-06 12:01:43', 2, 0),
	(44, 10, 10, '而非他人瓦上霜', 1, '2016-07-06 12:03:24', 2, 0),
	(45, 10, 10, '评论', 1, '2016-07-06 12:04:35', 2, 0),
	(46, 15, 20, '扯扯', 1, '2016-07-07 11:57:04', 2, 0),
	(47, 2, 20, '还好', 1, '2016-07-07 19:47:56', 15, 46),
	(48, 2, 20, '323e', 1, '2016-07-07 20:17:39', 2, 47),
	(49, 10, 24, '路过', 1, '2016-07-08 12:09:16', 2, 0),
	(50, 14, 24, '这个主题很赞！', 1, '2016-07-09 12:57:08', 2, 0),
	(51, 7, 24, '不错', 0, '2016-07-11 10:30:22', 2, 0),
	(52, 7, 24, '已报名', 1, '2016-07-11 10:30:51', 2, 0),
	(53, 7, 24, '赞', 0, '2016-07-11 11:03:53', 2, 0);
...
CREATE TABLE IF NOT EXISTS `activity_industry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 COMMENT='活动标签对映表';

-- 正在导出表  binggq.activity_industry 的数据：~27 rows (大约)
...
CREATE TABLE IF NOT EXISTS `activity_savant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='专家推荐活动关系表';

-- 正在导出表  binggq.activity_savant 的数据：~7 rows (大约)
...
INSERT INTO `admin` (`id`, `username`, `truename`, `password`, `phone`, `enabled`, `ctime`, `utime`, `login_time`, `login_ip`) VALUES
	(2, 'admin', '曹麦穗', '$2y$10$IwMcx3dYp7Sn.TPgovzc9Osem.XpMAdajZ1C.Z8y41LHcdcJUpCRy', '', 1, '2016-04-11 16:53:37', '2016-07-26 16:44:27', '2016-07-26 16:44:27', '127.0.0.1'),
...
CREATE TABLE IF NOT EXISTS `adminmsg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='后台系统消息';

-- 正在导出表  binggq.adminmsg 的数据：~9 rows (大约)
...
CREATE TABLE IF NOT EXISTS `admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='用户菜单表';

-- 正在导出表  binggq.admin_menu 的数据：~12 rows (大约)
...
INSERT INTO `candidate` (`id`, `job_id`, `truename`, `birthday`, `phone`, `email`, `address`, `career`, `education`, `salary`, `create_time`, `update_time`) VALUES
	...
	(2, 1, '王大锤', '2016-07-05', '18316629975', 'ada1@qq.com', '深南大道腾讯大厦', '来了卡了卡了', 'datepickerdatepickerdatepickerdatepicker', '20K~30K', '2016-07-21 14:26:06', '2016-07-21 14:34:58');
...
-- 正在导出表  binggq.career 的数据：~2 rows (大约)
DELETE FROM `career`;
...
-- 正在导出表  binggq.education 的数据：~2 rows (大约)
...
CREATE TABLE IF NOT EXISTS `flow` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户资金流水';
...
-- 正在导出表  binggq.job 的数据：~0 rows (大约)
DELETE FROM `job`;
/*!40000 ALTER TABLE `job` DISABLE KEYS */;
INSERT INTO `job` (`id`, `company`, `admin_id`, `contact`, `earnings`, `position`, `salary`, `address`, `summary`, `create_time`, `update_time`) VALUES
	(1, '腾讯科技', 3, '深南大道腾讯大厦', 1, '扫地阿姨', '20K~30K', '深南大道腾讯大厦', '要求扫地经验10年以上', '2016-07-21 11:34:32', '2016-07-21 11:43:37');
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  `create_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='重要的信息日志记录';

-- 正在导出表  binggq.log 的数据：~10 rows (大约)
DELETE FROM `log`;
...
INSERT INTO `meet_subject` (`id`, `user_id`, `title`, `summary`, `type`, `invite_time`, `price`, `address`, `last_time`, `create_time`, `update_time`) VALUES
	...
	(5, 10, '中型网络开发', '研发团队能力模型，工程预估', 1, '随时', 300.00, '深圳', 2, '2016-07-05 11:41:51', '2016-07-05 11:41:51'),
	(6, 17, '吃', '论如何吃成一个瘦子', 1, '夏天', 1.00, '西瓜园', 1, '2016-07-05 17:23:48', '2016-07-13 21:54:29');
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='菜单表';

-- 正在导出表  binggq.menu 的数据：~37 rows (大约)
DELETE FROM `menu`;
...
INSERT INTO `menu` (`id`, `name`, `node`, `pid`, `class`, `rank`, `is_menu`, `status`, `remark`) VALUES
	...
	(44, '话题管理', '/admin/meet-subject/index', 11, 'icon-rss', NULL, 1, 1, ''),
	...
	(66, '话题编辑', '/admin/meet-subject/edit', 0, '', NULL, 0, 1, ''),
	(67, '融资项目添加', '/admin/projrong/add', 19, '', NULL, 0, 0, ''),
	(68, '融资项目编辑', '/admin/projrong/edit', 19, '', NULL, 0, 1, ''),
	(69, '应聘添加', '/admin/candidate/add', 62, '', NULL, 0, 1, ''),
	(70, '应聘修改', '/admin/candidate/edit', 0, '', NULL, 0, 1, ''),
...
CREATE TABLE IF NOT EXISTS `need` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='小秘书';

-- 正在导出表  binggq.need 的数据：~14 rows (大约)
DELETE FROM `need`;
/*!40000 ALTER TABLE `need` DISABLE KEYS */;
INSERT INTO `need` (`id`, `pid`, `reply_id`, `user_id`, `msg`, `status`, `create_time`, `update_time`) VALUES
	(1, 0, 0, 8, '4624623', 0, '2016-05-18 15:55:44', '2016-05-18 15:55:44'),
	...
	(7, 0, 0, 10, '很好', 0, '2016-07-04 12:29:45', '2016-07-05 14:49:30'),
	(8, 0, 0, 7, '我', 0, '2016-07-05 14:20:41', '2016-07-05 14:28:53'),
	(9, 0, 0, 7, '我自己', 0, '2016-07-07 20:01:52', '2016-07-07 20:01:52'),
	(10, 9, 7, 2, '我自己', 0, '2016-07-07 20:02:29', '2016-07-07 20:02:29'),
	(12, 0, 0, 24, '你好', 0, '2016-07-09 21:09:40', '2016-07-09 21:09:40'),
	(13, 0, 0, 25, '哈喽', 0, '2016-07-11 11:30:34', '2016-07-11 11:30:34'),
...
CREATE TABLE IF NOT EXISTS `news` (
  ...
  PRIMARY KEY (`id`),
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='咨询表';

-- 正在导出表  binggq.news 的数据：~21 rows (大约)
DELETE FROM `news`;
/*!40000 ALTER TABLE `news` DISABLE KEYS */;
INSERT INTO `news` (`id`, `admin_id`, `admin_name`, `title`, `read_nums`, `praise_nums`, `comment_nums`, `cover`, `body`, `summary`, `create_time`, `update_time`, `user_id`, `source`, `keywords`, `thumb`) VALUES
...
CREATE TABLE IF NOT EXISTS `newscom` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8 COMMENT='新闻评论表';

-- 正在导出表  binggq.newscom 的数据：~75 rows (大约)
DELETE FROM `newscom`;
...
INSERT INTO `newscom` (`id`, `news_id`, `pid`, `user_id`, `reply_user`, `body`, `praise_nums`, `create_time`, `update_time`) VALUES
	...
	(46, 29, 0, 10, 0, '专家很棒', 1, '2016-06-25 20:29:28', '2016-06-30 20:09:06'),
	(47, 29, 0, 10, 0, 'ok', 2, '2016-06-25 20:30:08', '2016-07-06 10:22:42'),
	(48, 29, 47, 8, 10, '我回复我', 0, '2016-06-25 20:32:41', '2016-06-25 20:32:41'),
	(49, 29, 0, 10, 0, 'oookkk', 3, '2016-06-25 20:34:01', '2016-07-06 10:22:41'),
	...
	(60, 29, 0, 10, 0, 'test', 3, '2016-06-26 11:07:42', '2016-06-29 20:59:51'),
	(61, 29, 0, 17, 0, '一个大西瓜', 3, '2016-06-29 17:46:07', '2016-07-06 10:22:38'),
	(62, 29, 46, 19, 10, '帅哥', 3, '2016-06-29 17:57:48', '2016-07-05 20:20:28'),
	(63, 29, 0, 10, 0, '可以回复', 4, '2016-06-29 19:57:08', '2016-07-11 12:56:20'),
	(64, 19, 0, 10, 0, 'GG哈哈哈哈', 3, '2016-06-30 11:31:54', '2016-07-04 09:29:42'),
	(65, 19, 64, 19, 10, '我去', 4, '2016-06-30 13:23:15', '2016-07-05 20:21:02'),
	(66, 30, 0, 10, 0, '王石之困', 2, '2016-07-04 11:36:37', '2016-07-06 21:57:16'),
	(67, 29, 60, 19, 10, '我了', 0, '2016-07-05 20:55:29', '2016-07-05 20:55:29'),
	(68, 31, 0, 7, 0, '赞一个', 1, '2016-07-05 22:14:16', '2016-07-05 22:14:21'),
	(69, 31, 0, 10, 0, '赞一个', 2, '2016-07-06 11:52:29', '2016-07-08 12:08:02'),
	(70, 31, 0, 7, 0, '我自己', 1, '2016-07-06 11:59:59', '2016-07-08 12:07:45'),
	(71, 30, 0, 7, 0, '我的小学同桌说', 1, '2016-07-06 12:02:33', '2016-07-06 12:03:59'),
	(72, 29, 0, 10, 0, '我的人家说明', 1, '2016-07-06 12:03:46', '2016-07-11 12:56:06'),
	(73, 29, 0, 10, 0, '评论', 1, '2016-07-06 12:04:18', '2016-07-11 11:17:06'),
	(74, 29, 61, 10, 17, '消暑', 0, '2016-07-06 22:30:30', '2016-07-06 22:30:30'),
	(75, 29, 74, 2, 10, '回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容回复有很多内容', 1, '2016-07-07 19:49:27', '2016-07-11 11:17:30'),
	(76, 32, 0, 7, 0, '暴风挺住', 1, '2016-07-08 11:02:22', '2016-07-08 12:05:35'),
	(77, 31, 69, 7, 10, '呵呵', 1, '2016-07-08 11:02:46', '2016-07-08 12:07:44'),
	(78, 31, 0, 10, 0, '路过', 1, '2016-07-08 12:08:15', '2016-07-11 15:51:21'),
	(79, 32, 0, 14, 0, '资本市场就是这么风云变幻', 3, '2016-07-09 12:57:55', '2016-07-11 15:30:00'),
	(80, 32, 79, 7, 14, '赞评论', 0, '2016-07-11 10:31:26', '2016-07-11 10:31:26'),
	(81, 29, 74, 25, 10, '哪些', 1, '2016-07-11 11:17:18', '2016-07-11 11:17:25'),
	(82, 32, 79, 7, 14, '很好', 0, '2016-07-11 15:34:30', '2016-07-11 15:34:30'),
	(83, 29, 72, 26, 10, '看你', 0, '2016-07-11 15:34:47', '2016-07-11 15:34:47'),
	(84, 32, 0, 10, 0, '呵呵哒', 0, '2016-07-13 17:09:09', '2016-07-13 17:09:09');
...
CREATE TABLE IF NOT EXISTS `news_industry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='新闻行业标签';

-- 正在导出表  binggq.news_industry 的数据：~30 rows (大约)
...
CREATE TABLE IF NOT EXISTS `news_savant` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='专家推荐活动关系表';

-- 正在导出表  binggq.news_savant 的数据：~22 rows (大约)
...
INSERT INTO `projneed` (`id`, `title`, `body`, `needer`, `follower`, `stage_remark`, `create_time`, `update_time`) VALUES
	(2, '母婴健康交流', '2', '4', '2', '3', '2016-07-18 12:18:10', '2016-07-18 12:18:10');
/*!40000 ALTER TABLE `projneed` ENABLE KEYS */;


-- 导出  表 binggq.projneed_industry 结构
DROP TABLE IF EXISTS `projneed_industry`;
CREATE TABLE IF NOT EXISTS `projneed_industry` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `projneed_id` int(11) NOT NULL DEFAULT '0',
  `industry_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='需求项目标签';
...
CREATE TABLE IF NOT EXISTS `projrong` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='融资项目';

-- 正在导出表  binggq.projrong 的数据：~4 rows (大约)
DELETE FROM `projrong`;
/*!40000 ALTER TABLE `projrong` DISABLE KEYS */;
INSERT INTO `projrong` (`id`, `user_id`, `publisher`, `company`, `title`, `stage_id`, `address`, `scale_id`, `stock`, `read_nums`, `praise_nums`, `comment_nums`, `cover`, `body`, `summary`, `comp_desc`, `team`, `attach`, `status`, `follow_id`, `follower`, `stage_remark`, `create_time`, `update_time`) VALUES
	(2, 2, '曹文鹏', '腾讯科技', '母婴健康交流', 'A轮', '深圳市南山区腾讯大厦', '500人', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-04-22/5719a69da9447.jpg', '特特', '12', '33', '养生项目组', '/upload/proj/attach/2016-04-22/5719a6b8d85c9.pptx', NULL, 0, '', '', '0000-00-00 00:00:00', NULL),
	(3, 2, '并购帮', '腾讯科技', 'mysql 查询前一天', '3', '福田上沙333', '2', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-07-15/5788aa6fe416e.jpg', '45sgasdgdcagd', '交流会啊', '33', '33532', '/upload/proj/attach/2016-07-15/5788aa7f80c16.jpg', 0, 0, '', '', '0000-00-00 00:00:00', NULL),
	(4, 2, '并购帮', '腾讯科技', '母婴健康交流', '1', '深圳市南山区腾讯大厦', '1', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-07-26/57971f5ca775d.jpg', '12312', '12', '33', '养生项目组', '/upload/proj/attach/2016-07-15/5788e0b8e32e2.jpg', 0, 0, '范冰冰', '呵呵', '2016-07-15 21:41:00', '2016-07-26 16:29:19'),
	(5, 7, '郑旭', 'google', '完成灸疗店铺版开发', '1', '深圳市南山区腾讯大厦', '1', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-07-15/5788e9f27c082.jpg', '123', '交流会啊', '33', '养生项目组', '/upload/proj/attach/2016-07-15/5788e9fc67aee.jpg', 0, 0, '范冰冰', '123', '2016-07-15 21:49:00', '2016-07-15 21:49:00'),
	(6, 9, '游依婷', 'google', '母婴健康交流', '1', '深圳市南山区腾讯大厦', '1', '14%', NULL, NULL, NULL, '/upload/proj/cover/2016-07-18/578c370dc1dd5.jpg', '112', '交流会啊', '33', '养生项目组', '/upload/proj/attach/2016-07-18/578c371ea139a.jpg', 0, 0, '范冰冰', '进行中。', '2016-07-18 09:55:54', '2016-07-18 09:55:54');
...
-- 正在导出表  binggq.region 的数据：~2 rows (大约)
DELETE FROM `region`;
...
CREATE TABLE IF NOT EXISTS `rong_tag` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='融资项目行业标签';

-- 正在导出表  binggq.rong_tag 的数据：~7 rows (大约)
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='专家信息表';
...
CREATE TABLE IF NOT EXISTS `secret` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='隐私设置';

-- 正在导出表  binggq.secret 的数据：~11 rows (大约)
DELETE FROM `secret`;
...
CREATE TABLE IF NOT EXISTS `smsmsg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8 COMMENT='短信记录';
...
CREATE TABLE IF NOT EXISTS `sponsor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 COMMENT='活动赞助表';

-- 正在导出表  binggq.sponsor 的数据：~34 rows (大约)
DELETE FROM `sponsor`;
...
INSERT INTO `sponsor` (`id`, `user_id`, `activity_id`, `create_time`, `type`, `description`, `name`, `company`, `department`, `position`, `address`, `people`) VALUES
	...
	(16, 10, 14, '2016-06-30 21:12:35', 1, 'yyy', NULL, NULL, NULL, NULL, NULL, NULL),
	(17, 10, 14, '2016-06-30 21:12:37', 1, 'yyy', NULL, NULL, NULL, NULL, NULL, NULL),
	(18, 11, 10, '2016-07-01 12:13:51', 2, '1200平', NULL, NULL, NULL, NULL, NULL, NULL),
	(19, 10, 14, '2016-07-01 15:06:03', 1, 'tuijian ', NULL, NULL, NULL, NULL, NULL, NULL),
	(20, 7, 16, '2016-07-01 16:29:25', 2, '这', NULL, NULL, NULL, NULL, NULL, NULL),
	(21, 11, 10, '2016-07-01 21:27:58', 3, '100000', NULL, NULL, NULL, NULL, NULL, NULL),
	(22, 7, 16, '2016-07-05 10:53:46', 2, '我们的', NULL, NULL, NULL, NULL, NULL, NULL),
	(23, 7, 10, '2016-07-06 10:02:59', 1, '好', NULL, NULL, NULL, NULL, NULL, NULL),
	(24, 26, 21, '2016-07-11 13:00:23', 3, '50块', NULL, NULL, NULL, NULL, NULL, NULL),
	(25, 27, 24, '2016-07-11 15:55:57', 4, '测试', NULL, NULL, NULL, NULL, NULL, NULL),
	(26, 14, 24, '2016-07-11 16:24:23', 1, '我要', NULL, NULL, NULL, NULL, NULL, NULL),
	(27, 13, 24, '2016-07-11 16:24:47', 3, '现金赞助10万元', NULL, NULL, NULL, NULL, NULL, NULL),
	(28, 24, 24, '2016-07-11 16:24:49', 5, 'money', NULL, NULL, NULL, NULL, NULL, NULL),
	(29, 14, 24, '2016-07-11 16:24:51', 1, '我要做', NULL, NULL, NULL, NULL, NULL, NULL),
	(30, 14, 24, '2016-07-11 16:30:11', 2, '，a ku', NULL, NULL, NULL, NULL, NULL, NULL),
	(31, 24, 20, '2016-07-11 16:30:56', 1, 'one', NULL, NULL, NULL, NULL, NULL, NULL),
	(32, 7, 24, '2016-07-11 16:31:04', 3, '富含丰富风格', NULL, NULL, NULL, NULL, NULL, NULL),
	(33, 24, 21, '2016-07-11 16:31:19', 1, 'one', NULL, NULL, NULL, NULL, NULL, NULL),
	(34, 24, 24, '2016-07-11 16:31:54', 2, '北京', NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `subject_book` (`id`, `subject_id`, `user_id`, `savant_id`, `summary`, `status`, `create_time`, `update_time`) VALUES
	...
	(24, 3, 11, 7, 'dgjj', 1, '2016-07-01 21:34:17', '2016-07-05 22:13:02'),
	(25, 3, 17, 7, '我也来扯淡', 2, '2016-07-05 17:18:03', '2016-07-05 17:19:05'),
	(26, 6, 19, 17, '我也想吃西瓜', 3, '2016-07-05 18:09:21', '2016-07-05 18:12:39'),
	(27, 5, 7, 10, '高虎', 3, '2016-07-06 12:22:25', '2016-07-06 12:28:29'),
	(28, 3, 15, 7, '有一个广告', 3, '2016-07-06 12:29:09', '2016-07-06 12:30:16'),
	(29, 3, 15, 7, '我们', 0, '2016-07-06 12:29:34', '2016-07-06 12:29:34'),
	(30, 5, 7, 10, '我', 0, '2016-07-06 18:32:25', '2016-07-06 18:32:25'),
	(31, 5, 21, 10, '不错', 0, '2016-07-06 21:57:57', '2016-07-06 21:57:57'),
	(32, 3, 21, 7, '不错', 1, '2016-07-06 21:58:35', '2016-07-12 10:06:50'),
	(33, 5, 7, 10, '我', 0, '2016-07-07 19:49:26', '2016-07-07 19:49:26'),
	(34, 5, 7, 10, '我', 0, '2016-07-07 19:49:33', '2016-07-07 19:49:33'),
	(35, 5, 7, 10, '我自己的话', 0, '2016-07-07 19:49:48', '2016-07-07 19:49:48'),
	(36, 5, 7, 10, '一个人', 0, '2016-07-07 19:50:10', '2016-07-07 19:50:10'),
	(37, 3, 2, 7, '有一点', 0, '2016-07-07 19:52:03', '2016-07-07 19:52:03'),
	(38, 5, 7, 10, '这', 0, '2016-07-07 19:52:36', '2016-07-07 19:52:36'),
	(39, 4, 2, 7, '一', 0, '2016-07-07 19:52:52', '2016-07-07 19:52:52'),
	(40, 3, 15, 7, 'iii', 0, '2016-07-07 19:52:52', '2016-07-07 19:52:52'),
	(41, 3, 15, 7, '让人听', 0, '2016-07-07 19:53:08', '2016-07-07 19:53:08'),
	(42, 5, 7, 10, '你也喜欢', 0, '2016-07-07 19:54:31', '2016-07-07 19:54:31'),
	(43, 5, 7, 10, '你也喜欢传', 0, '2016-07-07 19:54:58', '2016-07-07 19:54:58'),
	(44, 5, 15, 10, '有意义', 0, '2016-07-07 19:55:23', '2016-07-07 19:55:23'),
	(45, 5, 15, 10, '有意义', 0, '2016-07-07 19:55:36', '2016-07-07 19:55:36'),
	(46, 5, 15, 10, '不会', 0, '2016-07-07 19:55:50', '2016-07-07 19:55:50'),
	(47, 5, 15, 10, '不要', 0, '2016-07-07 19:56:13', '2016-07-07 19:56:13'),
	(48, 4, 15, 7, '这是', 0, '2016-07-07 19:56:52', '2016-07-07 19:56:52'),
	(49, 4, 15, 7, '这是', 0, '2016-07-07 19:57:09', '2016-07-07 19:57:09'),
	(50, 4, 15, 7, '这是', 0, '2016-07-07 19:57:17', '2016-07-07 19:57:17'),
	(51, 4, 15, 7, '这是', 0, '2016-07-07 19:57:22', '2016-07-07 19:57:22'),
	(52, 4, 2, 7, '存在', 0, '2016-07-07 19:57:54', '2016-07-07 19:57:54'),
	(53, 4, 15, 7, '在', 0, '2016-07-07 19:58:30', '2016-07-07 19:58:30'),
	(54, 4, 2, 7, '存在', 0, '2016-07-07 19:58:39', '2016-07-07 19:58:39'),
	(55, 4, 2, 7, '款式', 0, '2016-07-07 19:59:55', '2016-07-07 19:59:55'),
	(56, 4, 15, 7, '都好好的\n', 3, '2016-07-07 20:00:45', '2016-07-11 18:06:44'),
	(57, 4, 15, 7, '高规格', 3, '2016-07-07 20:03:47', '2016-07-11 21:35:23'),
	(58, 3, 15, 7, '在一起', 3, '2016-07-07 20:05:10', '2016-07-11 21:03:21'),
	(59, 5, 7, 10, 'r r t', 0, '2016-07-07 20:08:13', '2016-07-07 20:08:13'),
	(60, 5, 7, 10, 'r r t', 0, '2016-07-07 20:08:18', '2016-07-07 20:08:18'),
	(61, 4, 10, 7, '天天天', 2, '2016-07-07 20:09:11', '2016-07-07 20:14:11'),
	(62, 3, 13, 7, '你好', 0, '2016-07-08 15:33:40', '2016-07-08 15:33:40'),
	(63, 4, 17, 7, '预约', 0, '2016-07-08 17:04:09', '2016-07-08 17:04:09'),
	(64, 4, 17, 7, '预约', 0, '2016-07-08 17:04:55', '2016-07-08 17:04:55'),
	(65, 4, 14, 7, '想学习', 0, '2016-07-09 12:45:56', '2016-07-09 12:45:56'),
	(66, 4, 15, 7, '跟哥哥哥哥哥哥风风光光', 0, '2016-07-11 16:22:14', '2016-07-11 16:22:14'),
	(67, 4, 13, 7, '请教', 0, '2016-07-11 16:55:35', '2016-07-11 16:55:35'),
	(68, 5, 15, 10, 'qqqwwwweeeeerr', 3, '2016-07-11 19:44:52', '2016-07-12 16:22:27'),
	(69, 3, 15, 7, 'weed 的热热热热热吃到一', 0, '2016-07-12 12:32:34', '2016-07-12 12:32:34');
...
-- 正在导出表  binggq.user 的数据：~19 rows (大约)
DELETE FROM `user`;
...
INSERT INTO `user` (`id`, `phone`, `user_token`, `union_id`, `wx_openid`, `app_wx_openid`, `truename`, `level`, `grade`, `idcard`, `company`, `position`, `email`, `gender`, `agency_id`, `ext_industry`, `goodat`, `city`, `card_path`, `avatar`, `money`, `meet_nums`, `fans`, `ymjy`, `ywnl`, `gsyw`, `reason`, `grbq`, `admin_id`, `status`, `savant_status`, `enabled`, `is_del`, `create_time`, `update_time`) VALUES
	(2, '', '', NULL, '', '', '并购帮', 3, 1, '', '', '', '', 1, 0, '', '', '', '/upload/user/mp/2016-07-11/578306d7c828a.jpg', '/upload/user/avatar/2016-07-07/thumb_577e35a2415aa.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-07-18 10:39:19', '2016-07-11 10:39:19'),
	(7, '18681509040', '', 'oglBHw957rd4_qnAjBb5HoEMSvSA', 'oqQRxswxqn-LYh2834g3168751yA', 'oplMIwqjBXqnmWjo0-C9D3EoX4zM', '郑旭', 2, 1, '', '柠檬智慧互联网咨询', '产品', 'claus@smartlemon.cn', 1, 17, '6642', '互联网咨询、传统企业转型升级', '深圳', '/upload/user/mp/2016-07-08/577f18a4c0e78.png', '/upload/user/avatar/2016-07-08/thumb_577f18645ec6e.png', 2550.00, 7, 6, '', '', '传统企业加速器', '更符合规范', 'a:1:{i:0;s:6:"产品";}', 0, 2, 3, 1, 1, '2016-05-05 18:46:01', '2016-07-19 18:05:01'),
	(9, '13560627825', '', 'oglBHw5Lw3uyiz_G-iPQ8riJtiLw', 'oqQRxs7Z-wldoLSVShHaaiaRLDEM', '', '游依婷', 1, 1, '', '广东深宏盾律师事务所', '', '71426333x@qq.com', 1, 28, '', '', '', '/upload/user/mp/2016-05-11/573312fbdeaa3.jpg', '/upload/user/avatar/2016-07-08/thumb_577f6408be79d.jpg', 0.00, 0, 1, '', '', NULL, '', 'a:1:{i:0;s:1:"a";}', 0, 1, 1, 1, 0, '2016-05-11 19:10:58', '2016-07-08 16:27:52'),
	(10, '13510663507', '5760b3d3207fk', 'oglBHw7ngF8JT7nLU7uf89n2kTMc', 'oqQRxs7aaLVQQQq6Ps4ae1FZx13g', 'oplMIwmgVK6mc1dAsDgXmT5LExYc', '周啸风', 2, 1, '', '柠檬智慧', '研发', 'xifeo@smartlemon.cn', 1, 5, '', '123asdfj j2222', '深圳', '/upload/user/mp/2016-06-07/5756bee45c3ac.jpg', '/upload/user/avatar/2016-07-08/thumb_577e826868f7f.png', 600.00, 2, 5, '', '', '咨询', '111', 'a:2:{i:0;s:6:"研发";i:1;s:6:"产品";}', 0, 1, 0, 1, 0, '2016-06-07 20:32:48', '2016-07-12 16:22:27'),
	(11, '15013797469', '', 'oglBHwydRTphIKEnYBRS1zfYvqkM', '', 'oplMIwlQbmVLv7QBsfLl8Dmm5EzE', 'key', 1, 1, '', '柠檬智慧咨询有限公司', 'web前端', '380552386@qq.com', 2, 11, '杂七杂八', '', '', '/upload/user/mp/2016-06-24/576ce8ff6448f.jpg', '/upload/user/avatar/2016-07-08/thumb_577f463787d70.jpg', 0.00, 0, 2, '', '', NULL, '奋斗奋斗', NULL, 0, 1, 0, 1, 0, '2016-06-24 16:04:00', '2016-07-08 15:38:15'),
	(12, '13510669757', '', NULL, '', '', '123', 1, 1, '', '123123', '123123', '123123@22.cn', 1, 0, '', '', '', '/upload/user/mp/2016-06-24/576d35e3805c7.jpg', '', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 2, 0, 0, '2016-06-24 21:30:14', '2016-07-07 19:28:22'),
	(13, '18576672803', '9d600de758dbdfcf32ad', 'oglBHw9b2Tnllf6Odqx7lxSN4YIQ', '', 'oplMIwtE0c9yt07HLCFfelxueWcc', '李芬', 1, 1, '', '并购菁英汇', '总裁', 'fannyli@chinama.club', 2, 20, '并购基金', '', '', '/upload/user/mp/2016-07-08/577f57f47a08a.png', '', 0.00, 0, 1, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-06-24 21:33:39', '2016-07-11 09:48:11'),
	(14, '18666822085', 'c65b3e2ca913bce64e86', NULL, '', '', '柳君', 1, 1, '', '并购菁英汇', '创始人', 'liujun@chinama.club', 2, 5, '结构化融资', '', '', '/upload/user/mp/2016-06-24/576d38f9f0e91.jpg', '/upload/user/avatar/2016-07-09/thumb_578083f798a7f.png', 0.00, 0, 2, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-06-24 21:44:07', '2016-07-12 00:18:06'),
	(15, '15914057632', '', 'oglBHw5JZx4fFFo85XM73g2ouL6M', '', 'oplMIwgh4reCtBkjnZuYYMorucbk', '杜胜佳', 1, 1, '', '柠檬智慧', 'iOS', '2394799027@qq.com', 1, 0, '', '', '', '/upload/user/mp/2016-07-12/57848aae127c7.png', '/upload/user/avatar/2016-07-12/thumb_5784a38353c2c.png', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-06-25 12:21:13', '2016-07-12 18:30:06'),
	(16, '18503039067', '0c64ded4de1144b70344', NULL, '', '', '高强', 1, 1, '', '柠檬智慧', 'PM', '37373838@qq.com', 1, 25, '', '', '', '/upload/user/mp/2016-06-25/576e83eec7e50.jpg', '', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 3, 1, 0, '2016-06-25 21:16:29', '2016-07-05 20:46:08'),
	(17, '13922806080', 'c7d35cc52e6fa749d63c', 'oglBHw3XLmsyQwxONqDYLheJ7Sis', 'oqQRxs60He2s7FCEU8OzXo45lg0M', '', '郑巽议', 2, 1, '', '柠檬', '产品', '1747371814@qq.com', 1, 5, '', '', '', '/upload/user/mp/2016-06-26/576f4b9b6d7e7.jpg', '', 1.00, 1, 1, 'AA受到法律思考的法律', '', NULL, '', NULL, 0, 2, 3, 1, 0, '2016-06-26 11:27:00', '2016-07-06 22:28:43'),
	(18, '13530229625', '04c4b10979bb30d6fe27', 'oglBHw4pSUtpwdN2GQkAIqdmb5Gs', 'oqQRxs7zWwx10JUNNFKs4iRMhVyw', 'oplMIwjL4adjAGV-59R_jUo7uAT4', '陈荣', 0, 1, '', '柠檬智慧', '设计师', '346159951@qq.com', 1, 5, '', '', '', '/upload/user/mp/2016-06-28/5771da1747f70.jpg', 'http://wx.qlogo.cn/mmopen/rElKOG5jB0J4mUeRNkicicYOQLl4y8IPHLtVYTnJ6Yqrk5MfwTsQQYiajyYavrEtZSAkxLjxicKOpSeG3Pvicqibx78Vj0bH5edvyR/0', 0.00, 0, 0, '', '', '测试测试 测试', '', 'a:2:{i:0;s:6:"研发";i:1;s:6:"设计";}', 0, 2, 1, 1, 0, '2016-06-28 10:00:15', '2016-07-07 18:12:39'),
	(20, '18681540783', '16926776095be98d0358', 'oglBHwxuSzg5OxxUVNVMY07M-0MQ', '', 'oplMIwl-UVA1js6Noy1y8rA7PpxY', '韦世魁', 0, 1, '', '柠檬智慧', '产品总监', 'welber@smartlelmon.cn', 1, 20, '', '', '', '/upload/user/mp/2016-07-04/577a5192a7099.jpg', '/upload/user/avatar/2016-07-04/thumb_577a52fbdecce.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-07-04 20:08:58', '2016-07-06 21:02:33'),
	(21, '18316629974', '51b98b86bbb3a5ddbf68', 'oglBHw-G5fbNmQeUoZiyWl_M1Dgc', 'oqQRxsx_srEukkVOBQMVWsmPDPbY', 'oplMIwnDMBxytRnkyYXcTE2J6JSE', '曹文鹏', 1, 1, '', '广州市时尚商业城有限公司', '总经理', 'caowenpeng1990@12.com', 1, 17, '', '', '', '/upload/user/mp/2016-07-08/577f2b055e9bb.jpg', '/upload/user/avatar/2016-07-08/thumb_577f44aed3af1.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 2, 1, 1, 0, '2016-07-05 22:10:42', '2016-07-12 20:38:18'),
	(22, '13650256334', '94a886347ebc45b448a6', 'oglBHww7VB8mFT7-EQ_WxvoFkgsM', '', 'oplMIwoPgcXKztmbadSrvy8E-Ubo', '雷婕', 1, 3, '', '柠檬智慧', '经理', 'xxx@qq.com', 1, 25, '', '', '深圳', '/upload/user/mp/2016-07-08/577f29df288d9.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 8, 1, 1, 1, 0, '2016-07-08 12:24:06', '2016-07-21 15:12:39'),
	(23, '15811808140', '9c8cd8c29490f4174cd7', 'oglBHw0LIPNi64Ag35GNL848-JCc', '', 'oplMIwp4tAXG7opso1-TaLvqtlgs', '后雅弘', 1, 3, '', '并购菁英汇', '运营专员', 'houyahong@chinama.club', 2, 5, '', '', '', '/upload/user/mp/2016-07-09/57800e41a323a.jpg', '/upload/user/avatar/2016-07-11/thumb_5782fff6e2f81.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-07-09 04:34:30', '2016-07-21 14:36:19'),
	(24, '13303913119', '052d6911dd4fdeff004f', 'oglBHwxgwhvWzVgqhzs1cS6dqAZI', '', 'oplMIwruc7-zBKKd72l_2yu0BMbM', '朱晋辉', 1, 2, '', '并购菁英汇', '运营专员', 'zhujinhui@chinama.club', 1, 20, '', '', '', '/upload/user/mp/2016-07-09/5780f6bd27c9e.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-07-09 21:07:44', '2016-07-21 14:35:55'),
	(25, '13246730326', 'cba0467b7f731f3023be', 'oglBHw46WOcXapmDEpCp2GJriSlc', '', 'oplMIwm_9I21V0fz4m2HWkhiuOTA', '黄嘉仪', 1, 1, '', '', '', '304290034@qq.com', 2, 5, '', '', '', '/upload/user/mp/2016-07-11/57830ad43ebee.png', '/mobile/images/touxiang.jpg', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 10:56:53', '2016-07-19 18:04:50'),
	(27, '13828817061', '0c323a5f13a14de84429', 'oglBHw9zVzzJEVtvJod8ql3qwGPU', '', 'oplMIwuAMLxO8nyk691lAHJFJzAg', '古思娜', 1, 1, '', '并购菁英汇', '', 'sir*a@chinama.club', 2, 20, '', '', '', '/upload/user/mp/2016-07-11/57835fa09a189.png', '/upload/user/avatar/2016-07-11/thumb_5783647939e2e.png', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 1, '2016-07-11 15:33:08', '2016-07-19 18:02:52'),
	(29, '1', 'efec6628488aa94091ed', NULL, '', '', '41', 1, 1, '', '12', '1231', '123@11.com', 1, 0, '', '', '', '1', '', 0.00, 0, 0, '', '', NULL, '', NULL, 0, 1, 1, 1, 0, '2016-07-22 19:20:56', '2016-07-22 20:31:02');
...
CREATE TABLE IF NOT EXISTS `usermsg` (
  ...
  `update_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=234 DEFAULT CHARSET=utf8 COMMENT='用户消息';
...
INSERT INTO `usermsg` (`id`, `user_id`, `type`, `table_id`, `title`, `msg`, `num`, `url`, `status`, `create_time`, `update_time`) VALUES
	...
	(144, 21, 4, 32, '预约通知', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', 0, '', 0, '2016-07-06 22:01:39', '2016-07-06 22:01:39'),
	(145, 21, 4, 32, '预约通知', '您预约的话题：《互联网开发讲座》已确认通过，请及时登录平台支付预约款。', 0, '', 0, '2016-07-06 22:01:40', '2016-07-06 22:01:40'),
...
CREATE TABLE IF NOT EXISTS `user_industry` (
  ...
  `industry_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8 COMMENT='用户行业标签';

-- 正在导出表  binggq.user_industry 的数据：~41 rows (大约)
...
-- 正在导出表  binggq.withdraw 的数据：~0 rows (大约)
