...
class SubjectBookFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subject_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '话题id', 'precision' => null, 'autoIncrement' => null],
        'user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '用户id', 'precision' => null, 'autoIncrement' => null],
        'savant_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '专家id', 'precision' => null, 'autoIncrement' => null],
        'summary' => ['type' => 'string', 'length' => 550, 'null' => false, 'default' => '', 'comment' => '需求简介', 'precision' => null, 'fixed' => null],
        'status' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '0,未确认1确认通过2不予通过3完成', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'create_time' => '2016-05-30 17:24:41',
            'update_time' => '2016-05-30 17:24:41'
        ],
    ];
}
