...
class WithdrawFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ctime' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => '0000-00-00 00:00:00', 'comment' => '', 'precision' => null],
        'utime' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => '0000-00-00 00:00:00', 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'status' => 1,
            'ctime' => '2016-06-14 15:06:28',
            'utime' => '2016-06-14 15:06:28'
        ],
    ];
}
