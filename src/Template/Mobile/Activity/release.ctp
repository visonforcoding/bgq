...
<!--        <span class='closed'>
    ...
    <div class="totips" hidden id="checkBtn">
        ...
        <a href="javascript:void(0)" class="tipsbtn bggray" id="no">取消</a><a href="javascript:location.href = ('/home/edit_userinfo?ref='+encodeURI(location.href))" class="tipsbtn bgred" id="yes">去完善</a>
    </div>
</div>
<?= $this->element('footer'); ?>
