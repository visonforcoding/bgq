<div class="wraper bg-ff">
    <div class="head-info">
        ...
        <a href="<?php if($self): ?>/home/edit-userinfo<?php else: ?>javascript:void(0)<?php endif; ?>" class="m-pic"><span><img src="<?= $user->avatar ? getOriginAvatar($user->avatar) : '/mobile/images/touxiang.png' ?>"/></span></a>
    </div>
    <div class="h-user">
        <h3><?= $user->truename ?></h3>
