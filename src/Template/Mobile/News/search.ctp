...
<div class="fixedwraper">
    <div class='h-news-search'>
        ...
        <div class='h-regiser' id="doSearch" style="position: relative;right: 0;font-size: 0.28rem;width: 0.7rem; padding: 0.12rem 0 0.14rem;color:#fff;background: #dd1f4b;border-radius: 0.1rem;
