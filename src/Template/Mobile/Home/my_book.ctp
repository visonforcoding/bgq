...
<div class="wraper">
    ...
    <script type="text/html" id="tpl">
        <section class="internet-v-info mt20">
            <div class="innercon">
                <span class="head-img"><a href="/user/home-page/{#user_id#}"><img src="{#user_logo#}"/>{#v#}</a></span>
                ...
                if (type == 'books') {
                    if (status === '1') {
                        ...
                        if (d.is_done) {
                            ...
                            d.subject_status = '<div class="f-box"><div class="f-info"><span class="fl f-type"><i class="iconfont">&#xe62f;</i>约见详情</span><a class="fr f-link" href="/home/my-book-detail/' + d.id + '">查看<i class="iconfont">&#xe667;</i></a></div>';
                        }
                    } else {
                    ...
                    if (status === '1') {
                        ...
                        if (d.is_done) {
                            ...
                            d.subject_status = '<div class="f-box"><div class="f-info"><a href="/home/my-book_savant_detail/' + d.id + '" class="fl f-type"><i class="iconfont">&#xe62f;</i>约见详情</a><a class="fr f-btn done"><span subject_id="' + d.id + '" id="subjectId_' + d.id + '">完成</span></a></div>';
                        }
                    } else {
