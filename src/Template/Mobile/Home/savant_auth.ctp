    ...
    <ul class="h-info-box e-info-box">
        ...
        <form method="post" action="">
            <li class="no-right-ico changeflex">
                <b>项目经验</b>
                <div >
                    <textarea name="xmjy" <?php if($user->savant_status!=1): ?>readonly<?php endif; ?>><?=isset($user->savant)?$user->savant->xmjy:''?></textarea>
                </div>
            </li>
            <li class="nobottom no-right-ico changeflex">
                <b>资源优势</b>
                <div >
                    <textarea name="zyys" <?php if($user->savant_status!=1): ?>readonly<?php endif; ?>><?=  isset($user->savant)?$user->savant->zyys:''?></textarea>
                </div>
            </li>
        </form>
    </ul>
