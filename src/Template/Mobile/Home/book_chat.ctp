                ...
                if (res.status) {
                    var html = $.util.topDataToTpl('', 'tpl', res.data, function (d) {
                        ...
                        if (d.user.id == uid) {
                            ...
                            d.user_avatar = d.user.avatar ? d.user.avatar : '/mobile/images/touxiang.png';
                            msg += '<li class="fl"><div class="flex chatbox"><a class="avatar" style="display:inline-block;"><img src="'+d.user_avatar+'"></a></div><div class="chat_text"><span>' + d.content + '</span></div></div></li>';
                        }
                        d.msg = msg;
                        return d;
                    });
