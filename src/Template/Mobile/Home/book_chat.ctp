                ...
                if (res.status) {
                    var html = $.util.topDataToTpl('', 'tpl', res.data, function (d) {
                        ...
                        if (d.user.id == uid) {
                            ...
                            msg += '<li><div class="flex fr chatbox"><div class="chat_text"><span>'+d.content+'</span></div><a class="avatar ablock" href="/user/home-page/'+ d.user.id +'"><img src="'+d.user_avatar+'"></a></div></div></li>';
                        } else {
                            d.user_avatar = d.user.avatar ? d.user.avatar : '/mobile/images/touxiang.png';
                            msg += '<li><div class="flex fl chatbox"><a class="avatar ablock" href="/user/home-page/'+d.user.id+'"><img src="'+d.user_avatar+'"></a></div><div class="chat_text"><span>' + d.content + '</span></div></div></li>';
                        }
                        d.msg = msg;
                        return d;
                    });
