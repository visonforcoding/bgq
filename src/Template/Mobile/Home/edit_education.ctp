    ...
    <div class="education-items" style="display: none">
        ...
        <ul class="h-info-box e-info-box">
            ...
            <li class='no-right-ico'>
                <span>开始日期：</span>
                <div>
                    <input name="start_date" maxlength="10" type="text" placeholder="<?php echo date('Y-m-d'); ?>" class="checktime" />
                </div>
            </li>
            <li class="no-b-border no-right-ico">
                <span>结束日期：</span>
                <div>
                    <input name="end_date" maxlength="10" type="text" placeholder="<?php echo date('Y-m-d'); ?>" class="checktime" />
                </div>
            </li>
