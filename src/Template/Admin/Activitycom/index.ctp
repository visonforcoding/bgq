...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/activitycom/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
        ...
        $("#list").jqGrid({
            url: "/admin/activitycom/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['用户id','活动id','评论内容','点赞数','评论时间','å›žå¤ç”¨æˆ·id','¸¸id','操作'],
            colModel: [
...
{name:'reply_id',editable:true,align:'center'},
