...
<!--    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php
            echo $this->Form->input('bonus_start_time', ['label' => false, 'type' => 'text', 'value' => $course->bonus_start_time->i18nFormat('yyyy-MM-dd HH:mm:ss'), 'class' => 'datetimepicker form-control']);
            ?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php
            echo $this->Form->input('bonus_end_time', ['label' => false, 'type' => 'text', 'value' => $course->bonus_end_time->i18nFormat('yyyy-MM-dd HH:mm:ss'), 'class' => 'datetimepicker form-control']);
            ?>
        </div>
    </div>-->
    <div class="form-group">
