...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($mentorSubscribe, ['class' => 'form-horizontal']) ?>
        <div class="form-group">
        <label class="col-md-2 control-label">用户id</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('uid', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">导师id</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('mentor_id', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">是否已取消订阅</label>
        <div class="col-md-8">
                        <?php
