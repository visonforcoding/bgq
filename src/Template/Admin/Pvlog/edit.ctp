...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($pvlog, ['class' => 'form-horizontal']) ?>
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('screen', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">访问页</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('refer', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('act', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">用户头</label>
        <div class="col-md-8">
                        <?php
                    ...
                    if (typeof res === 'object') {
                        if (res.status) {
                            layer.alert(res.msg, function () {
                                window.location.href = '/admin/pvlog/index';
                            });
                        } else {
