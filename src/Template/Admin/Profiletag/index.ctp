...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/profiletag/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
        ...
        $("#list").jqGrid({
            url: "/admin/profiletag/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['个人标签','操作'],
...
//        response += '<a title="查看" onClick="doView(' + rowObject.id + ');" data-id="' + rowObject.id + '" class="grid-btn "><i class="icon icon-eye-open"></i> </a>';
        response += '<a title="编辑" href="/admin/profiletag/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/profiletag/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                
             function doView(id) {
                //查看明细
                url = '/admin/profiletag/view/'+id;
                layer.open({
                    type: 2,
                    title: '查看详情',
                    shadeClose: true,
