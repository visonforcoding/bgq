    ...
    <div class="panel">
        ...
        <div id="intChart" class="chart-bar row" style="margin:10px;">
            <div class="col-md-4">
                ...
                <button data-val="praise" class="btn btn-primary  chart-column-btn"><i class="icon icon-user red"></i> 点赞</button>
                <button data-val="comment" class="btn  chart-column-btn"><i class="icon icon-usecase red"></i> 评论</button>
            </div>
