...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/projneed/add" class="btn btn-small btn-warning">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/projneed/getDataList",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                                ['标题', '需求方', '跟进人', '进度描述', '创建时间', '更新时间', '操作'],
                        colModel: [
                            {name: 'title', editable: true, align: 'center'},
                            {name: 'needer', editable: true, align: 'center'},
                            {name: 'follower', editable: true, align: 'center'},
                            {name: 'stage_remark', editable: true, align: 'center'},
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/admin/projneed/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/projneed/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }

                function doView(id) {
                    //查看明细
                    url = '/admin/projneed/view/' + id;
                    layer.open({
                        type: 2,
                        title: '查看详情',
                        shadeClose: true,
