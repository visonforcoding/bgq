...
<div class="work-copy">
    <?= $this->Form->create($beauty, ['class' => 'form-horizontal']) ?>
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('constellation', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('brief', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">是否审核通过：0：未审核；1：审核通过；2：审核未通过</label>
        <div class="col-md-8">
                        <?php
