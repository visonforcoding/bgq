...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($collectLog, ['class' => 'form-horizontal']) ?>
            ...
            <label class="col-md-2 control-label">用户id</label>
                ...
                <?php echo $this->Form->input('user_id', ['label' => false,'options' => $users,'class'=>'form-control']);?>
                 ...
                 <div class="form-group">
            <label class="col-md-2 control-label">关联id（活动id或资讯id）</label>
                <div class="col-md-8">
                <?php echo $this->Form->input('relate_id', ['label' => false,'options' => $activities,'class'=>'form-control']);?>
                      </div>
         </div>
            <div class="form-group">
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">类型值：0：活动；1：资讯</label>
        <div class="col-md-8">
                        <?php
                    ...
                    if (typeof res === 'object') {
                        if (res.status) {
                            layer.alert(res.msg, function () {
                                window.location.href = '/admin/collectlogs/index';
                            });
                        } else {
