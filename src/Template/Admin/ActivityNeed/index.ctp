...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/activityneed/add" class="btn btn-small btn-warning">
                <i class="icon icon-plus-sign"></i>添加
            </a>
            <div class="form-group">
                <label for="keywords">关键字</label>
                <input type="text" name="keywords" class="form-control" id="keywords" placeholder="姓名、公司、活动标题">
            </div>
            <div class="form-group">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/activityneed/getDataList",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                                ['姓名', '公司', '职位', '活动', '创建时间', '修改时间', '操作'],
                        colModel: [
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/admin/activityneed/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/activityneed/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
