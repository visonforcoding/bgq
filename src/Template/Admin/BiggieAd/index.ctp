...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/biggieAd/add" class="btn btn-small btn-warning">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/biggieAd/getDataList",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                                ['大咖', '图片地址', '创建时间', '操作'],
                        colModel: [
                            ...
                            {name: 'url', editable: true, align: 'center',formatter:function(cellvalue,options,rowObject){
                                return '<a title="查看名片" href="' + rowObject.url + '" data-lightbox="' + rowObject.id + '" data-title="" ><i class="icon icon-picture"></i> </a>';
                            }},
