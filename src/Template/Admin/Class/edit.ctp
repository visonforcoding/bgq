...
<div class="work-copy">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <?php
            echo $this->cell('Mentor', [[$clas->mentor_id]]);
            ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group media audio">
        ...
        <div class="col-md-8">
            <input name="audio" type="text" readonly class="form-control" value="<?= $clas->audio ?>"/>
...
<!--            <div class="col-md-8 form-group mt10">
                ...
                <input name="audio_title" type="text"  placeholder="音频标题" class="inner-input"  value="<?= $clas->audio_title ?>"/>
            </div>-->
        </div>
    </div>
    <div class="form-group media audio">
        ...
        <div class="col-md-8">
            <input name="zip" type="text" readonly class="form-control" value="<?= $clas->zip ?>"/>
            <div id="zip"  class="jqupload"></div>
            <span class="notice" style=" display: block">(*文件仅支持格式为zip,直接改后缀会导致解压缩失败;压缩包里面的图片请直接使用PPT导出jpg,不要修改任何图片或图片名,不要带有一层文件夹)</span>
<!--            <div class="col-md-8 form-group mt10">
                <label style=" display: inline-block;">音频标题</label>
