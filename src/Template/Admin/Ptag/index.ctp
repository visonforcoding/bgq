...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/ptag/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
       ...
       $(document).keypress(function (e) {
        ...
        $("#list").jqGrid({
            url: "/admin/ptag/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['ptag','描述','create_time','update_time','操作'],
            colModel: [
...
{name:'actionBtn',align:'center',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/admin/ptag/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/ptag/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                
             function doView(id) {
                //查看明细
                url = '/admin/ptag/view/'+id;
                layer.open({
                    type: 2,
                    title: '查看详情',
                    shadeClose: true,
