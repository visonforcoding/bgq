...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/articles/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
        ...
        $("#list").jqGrid({
            url: "/admin/articles/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['title','操作'],
...
{name:'actionBtn',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a href="/admin/articles/edit/' + rowObject.id + '" class="grid-btn btn btn-primary btn-mini"><i class="icon icon-pencil"></i> 修改</a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.store.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/articles/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
                
             function doView(id) {
                //查看明细
                url = '/admin/articles/view?id='+id;
                layer.open({
                    type: 2,
                    title: '查看详情',
                    shadeClose: true,
