...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/like-logs/getDataList/<?= $id; ?><?php if(isset($type)):?>?type=<?=$type?><?php endif;?>",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/likelogs/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }

                function doView(id) {
                    //查看明细
                    url = '/admin/likelogs/view/' + id;
                    layer.open({
                        type: 2,
                        title: '查看详情',
                        shadeClose: true,
