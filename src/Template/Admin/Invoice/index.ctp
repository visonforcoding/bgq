    ...
    $(function () {
       ...
       $(document).keypress(function (e) {
        ...
        $("#list").jqGrid({
            ...
            mtype: "POST",
            colNames:   
['用户id','是否是增值税发票','公司名称','总金额','收件人','收件人电话','收件人地址','纳税人识别号','公司地址','公司电话','开户行','开户账号','是否发货','快递','快递单号','创建时间','更新时间','操作'],
            colModel: [
{name:'user_id',editable:true,align:'center'},
{name:'is_VAT',editable:true,align:'center'},
{name:'company',editable:true,align:'center'},
{name:'sum',editable:true,align:'center'},
...
{name:'registration_num',editable:true,align:'center'},
{name:'company_address',editable:true,align:'center'},
{name:'company_phone',editable:true,align:'center'},
{name:'bank',editable:true,align:'center'},
{name:'bank_account',editable:true,align:'center'},
{name:'is_shipment',editable:true,align:'center'},
...
{name:'actionBtn',align:'center',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a title="编辑" href="/admin/invoice/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
        return response;
    }
