    ...
    <div class="panel">
        ...
        <div id="intChart" class="chart-bar row" style="margin:10px;">
            <div class="col-md-3 btn-group">
                ...
                <button data-val="recharge" class="btn btn-primary  chart-column-btn"><i class="icon icon-user red"></i> 充值</button>
                <button data-val="gift" class="btn  chart-column-btn"><i class="icon icon-usecase red"></i> 赠送</button>
        ...
        <div class="panel-body">
            <div id="recharge_chart" style="width:100%;height:400px;" >
...
<script>
        $(function () {
                    var recharge_chart = echarts.init(document.getElementById('recharge_chart'));
...
//                    var level_chart = echarts.init(document.getElementById('level_chart'));
                    ...
                    var url = '/admin/recharge-gift/get-recharge-chart';
                    var type = $('#choice-time-type').val();
                    initLineChart(url + '?date=' + date + '&type=' + type, recharge_chart);
...
//                    }, 'json');
                    ...
                    $('#choice_date,#choice-time-type').change(function () {
                        ...
                        var url = '/admin/recharge-gift/get-recharge-chart';
                        if (column == 'recharge') {
                            url = '/admin/recharge-gift/get-recharge-chart';
                        }
                        if (column == 'gift') {
                            url = '/admin/recharge-gift/get-gift-chart';
                        }
//                        if (column == 'mp') {
...
//                        }
                        ...
                        initLineChart(url, recharge_chart);
                    });
                });
