...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/bookchat/add" class="btn btn-small btn-warning">
                <i class="icon icon-plus-sign"></i>添加
            </a>
            <div class="form-group">
                <label for="keywords">关键字</label>
                <input type="text" name="keywords" class="form-control" id="keywords" placeholder="内容">
            </div>
            <div class="form-group">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        ...
                        colModel: [
                            ...
                            {name: 'reply_user', editable: true, align: 'center',formatter:function(cell,opt,obj){
                                    return cell.truename+'-'+cell.company+'-'+cell.position;
                            }},
                            {name: 'subject_book.subject', editable: true, align: 'center',formatter:function(cell,opt,obj){
                                    return cell.title;
                            }},
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/admin/bookchat/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
