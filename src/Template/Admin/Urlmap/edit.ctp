...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($urlmap, ['class' => 'form-horizontal']) ?>
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">映射</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('map', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
                    ...
                    if (typeof res === 'object') {
                        if (res.status) {
                            layer.alert(res.msg, function () {
                                window.location.href = '/admin/urlmap/index';
                            });
                        } else {
