...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <!--            <a href="/admin/urlmap/add" class="btn btn-small btn-warning">
...
<script>
                        ...
                        colModel: [
                            {name: 'url', editable: true, align: 'center', width:'800px', formatter:function(cell,opt,obj){
                                    ...
                                    if(cell.match(/http:\/\/.*\/.*\.*\/[0-9]+.*/)){
                                        res += '&nbsp;&nbsp;<a href="/admin/pvchart/urlchart?url='+encodeURIComponent(cell)+'">查看该页汇总</a>'
                                    }
                                    return res;
                            }},
                            {name: 'map', editable: true, align: 'center'},
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/admin/urlmap/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/urlmap/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }

                function doView(id) {
                    //查看明细
                    url = '/admin/urlmap/view/' + id;
                    layer.open({
                        type: 2,
                        title: '查看详情',
                        shadeClose: true,
