...
<!--            <a href="/admin/actionlog/add" class="btn btn-small btn-warning">
                <i class="icon icon-plus-sign"></i>添加
            </a>-->
            <div class="form-group">
                <label for="keywords">关键字</label>
                <input type="text" name="keywords" class="form-control" id="keywords" placeholder="操作者">
            </div>
            <div class="form-group">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/actionlog/getDataList",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                                ['请求地址', '请求类型', '客户端IP', '日志内容', '控制器', '动作', '请求参数', '操作者', '创建时间', '操作'],
                        colModel: [
                            ...
                            {name: 'param', editable: true, align: 'center'},
...
//                    response += '<a title="编辑" href="/admin/actionlog/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/actionlog/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }

                function doView(id) {
                    //查看明细
                    url = '/admin/actionlog/view/' + id;
                    layer.open({
                        type: 2,
                        title: '查看详情',
                        shadeClose: true,
