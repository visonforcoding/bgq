...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/mentor/add" class="btn btn-small btn-warning">
                <i class="icon icon-plus-sign"></i>添加
            </a>
            <div class="form-group">
                <label for="keywords">关键字</label>
                <input type="text" name="keywords" class="form-control" id="keywords" placeholder="姓名、公司、职位">
            </div>
            <div class="form-group">
...
<script>
                $(function () {
                    ...
                    $("#list").jqGrid({
                        url: "/admin/mentor/getDataList",
                        datatype: "json",
                        mtype: "POST",
                        colNames:
                                ['姓名', '公司', '职位', '订阅数', '创建时间', '更新时间', '操作'],
                        colModel: [
                ...
                function actionFormatter(cellvalue, options, rowObject) {
                    ...
                    response += '<a title="编辑" href="/admin/mentor/edit/' + rowObject.id + '" class="grid-btn "><i class="icon icon-pencil"></i> </a>';
                    return response;
                }
                ...
                function doExport() {
                    ...
                    $("body").append("<iframe src='/admin/mentor/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }

                function doView(id) {
                    //查看明细
                    url = '/admin/mentor/view/' + id;
                    layer.open({
                        type: 2,
                        title: '查看详情',
                        shadeClose: true,
