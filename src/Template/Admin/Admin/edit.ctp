...
<div class="work-copy">
    <?= $this->Form->create($admin, ['class' => 'form-horizontal']) ?>
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('login_time', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">登录ip</label>
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('login_ip', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
