...
<!--    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('num', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('offer_addr', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('job_order', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
<!--    <div class="form-group">
