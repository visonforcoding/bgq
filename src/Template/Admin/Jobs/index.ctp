...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/jobs/add" class="btn btn-small btn-warning">
                    ...
                    $("#list").jqGrid({
                        ...
                        colModel: [
                            ...
                            {name: 'offer_range', editable: true, align: 'center', formatter: function (cellvalue, options, rowObject) {
                                    if (cellvalue) {
                                        var offer_range = cellvalue.replace(/,/gm, '-');
                                        return offer_range;
                                    }
                                }},
                            ...
                            {name: 'job_order', editable: true, align: 'center', formatter: function (cellvalue, options, rowObject) {
                                    if (cellvalue == '1') {
                                        return '已置顶';
                                    } else {
                                        return '否';
