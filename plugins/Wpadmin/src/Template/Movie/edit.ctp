...
<?php $this->end() ?> 
<div class="work-copy">
    <?= $this->Form->create($movie, ['class' => 'form-horizontal']) ?>
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('movie', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        ...
        <div class="form-group">
        <label class="col-md-2 control-label">ctime</label>
        <div class="col-md-8">
                        <?php
        ...
        <div class="col-md-8">
                        <?php
            echo $this->Form->input('hits', ['label' => false, 'class' => 'form-control']);
            ?>
        </div>
    </div>
        <div class="form-group">
        <label class="col-md-2 control-label">utime</label>
        <div class="col-md-8">
                        <?php
