...
<div class="col-xs-12">
    <form id="table-bar-form">
        <div class="table-bar form-inline">
            <a href="/admin/movie/add" class="btn btn-small btn-warning">
...
<script>
    $(function () {
        ...
        $("#list").jqGrid({
            url: "/admin/movie/getDataList",
            datatype: "json",
            mtype: "POST",
            colNames:   
['pic','movie','url','ctime','hits','utime','操作'],
            colModel: [
{name:'pic',editable:true,align:'center'},
{name:'movie',editable:true,align:'center'},
{name:'url',editable:true,align:'center'},
{name:'ctime',editable:true,align:'center'},
{name:'hits',editable:true,align:'center'},
...
{name:'actionBtn',viewable:false,sortable:false,formatter:actionFormatter}],
    ...
    function actionFormatter(cellvalue, options, rowObject) {
        ...
        response += '<a href="/admin/movie/edit/' + rowObject.id + '" class="grid-btn btn btn-primary btn-mini"><i class="icon icon-pencil"></i> 修改</a>';
        return response;
    }
            ...
            function doSearch() {
                ...
                function doExport() {
                   ...
                   var searchData = $.zui.store.pageGet('searchData')?$.zui.stroe.pageGet('searchData'):{};
                    ...
                    $("body").append("<iframe src='/admin/movie/exportExcel?" + searchQueryStr + "' style='display: none;' ></iframe>");
                }
</script>
<?php
$this->end();
